import { Box, type ScrollBoxHandle, stringWidth, Text } from '@hbm/ink'
import { compactNumber } from '@hbm/shared/format'
import type { Usage } from '@hbm/shared/gateway-events'
...
export function StatusRule({
  ...
  // Dev-only readout (HBM_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (HBM_DEV_CREDITS), lowest priority,
