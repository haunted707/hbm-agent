...
import { InputEvent } from '../../packages/hbm-ink/src/ink/events/input-event.js'
import { INITIAL_STATE, parseMultipleKeypresses } from '../../packages/hbm-ink/src/ink/parse-keypress.js'
...
// web/src/lib/pty-keyboard-shortcuts.ts). hbm-ink decodes that bare
