...
import type { ScrollBoxHandle } from '@hbm/ink'
import { evictInkCaches } from '@hbm/ink'
import type { InflightTurn, SessionResumeResult, Usage } from '@hbm/shared/gateway-events'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.HBM_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
