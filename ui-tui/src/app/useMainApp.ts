...
import { JSON_RPC_METHOD_NOT_FOUND, type ServerRequest } from '@hbm/shared/json-rpc-channel'
...
export function useMainApp(gw: GatewayClient) {
  ...
  // "HBM AGENT stopped and could not be restarted" is said once per outage; reset on gateway.ready.
  ...
  const cwd = ui.info?.cwd || process.env.HBM_CWD || process.cwd()
