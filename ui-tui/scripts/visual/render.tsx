 ...
 * across theme x background scenes to <tmpdir>/hbm-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@hbm/ink'
...
// The regenerated slate light_colors block from hbm_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/hbm-agent',
...
const setup = (bgHex: string) => {
  process.env.HBM_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
