...
await build({
  ...
  // Skip the prebuilt @hbm/ink bundle and inline the source instead:
  ...
  alias: { '@hbm/ink': resolve(root, 'packages/hbm-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The hbm_cli launcher
