"""The `hbm-agent` skill is what a running HBM AGENT knows about itself.

`website/` is never packaged, so an installed HBM AGENT has no local copy of the
user guide; skills ARE synced into `$HBM_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "HBM AGENT can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "hbm-agent"
