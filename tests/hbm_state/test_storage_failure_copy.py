...
@pytest.mark.parametrize(
    ...
    [
        ...
        (sqlite3.OperationalError("attempt to write a readonly database"), "storage_readonly", "hbm doctor --fix"),
        (sqlite3.DatabaseError("database disk image is malformed"), "storage_corrupt", "hbm doctor --fix"),
        (OSError(28, "No space left on device"), "disk_full", "Free some disk space"),
        (None, "storage_unavailable", "hbm doctor --fix"),
    ],
)
