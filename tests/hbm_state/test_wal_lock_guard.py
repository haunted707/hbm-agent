...
after update"). ``hbm_state_lockguard`` re-holds the same ranges as OFD locks that a stray
...
from tests.hbm_state._wal_generation_harness import make_db, pin_wal, require_wal
