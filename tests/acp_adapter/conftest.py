...
Keeps the ACP server tests offline: ``HbmACPAgent._build_model_state``
calls ``hbm_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import hbm_cli.inventory as inventory
