...
The unit tests in tests/hbm_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned hbm-writable by the
...
from hbm_cli.service_manager import S6ServiceManager
