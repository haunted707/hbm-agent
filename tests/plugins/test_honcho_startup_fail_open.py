...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "hbm honcho peer --user", "Do not suggest peerName"),
    ("telegram", "Do not suggest peerName", "hbm honcho peer --user"),
])
...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "hbm honcho peer --user", "could not be initialized"),
    ("discord", "supplied no user id", "hbm honcho peer --user"),
])
