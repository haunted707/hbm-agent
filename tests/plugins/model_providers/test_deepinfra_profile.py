...
against a gateway-wide enum (``none``..``max``; HBM AGENT-internal ``ultra`` is rejected). The
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"enabled": True, "effort": "ultra"}, {"reasoning_effort": "max"}),  # HBM AGENT-internal tier clamps
