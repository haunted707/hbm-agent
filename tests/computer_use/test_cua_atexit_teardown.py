...
caches it for the life of the HBM AGENT process. Nothing ever tore it down, so
the driver outlived the session that started it (#28152 item 3 — "HBM AGENT does
