...
def _make_adapter(
    ...
    *,
    ...
    monkeypatch.setenv("HBM_DISCORD_LIVENESS_INTERVAL_SECONDS", str(interval))
    monkeypatch.setenv("HBM_DISCORD_LIVENESS_FAILURE_THRESHOLD", str(threshold))
    extra = {
...
def test_platform_config_extra_overrides_process_liveness_bridge(monkeypatch):
    monkeypatch.setenv("HBM_DISCORD_LIVENESS_INTERVAL_SECONDS", "99")
    monkeypatch.setenv("HBM_DISCORD_LIVENESS_FAILURE_THRESHOLD", "9")
