...
def store(tmp_path, monkeypatch):
    ...
    ~/.hbm/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at hbm_state import time, before pytest's HBM_HOME monkeypatch
    fires — the autouse fixture's HBM_HOME override doesn't help here.)
    """
    import hbm_state
