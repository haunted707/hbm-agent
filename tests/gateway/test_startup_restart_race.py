...
def _patch_aborted_startup(monkeypatch, runner_cls):
    ...
    monkeypatch.setattr("hbm_logging.setup_logging", lambda hbm_home, mode: None)
...
async def test_failure_exit_still_stops_cron_housekeeping_and_mcp(monkeypatch):
    ...
    monkeypatch.setattr("hbm_cli.nous_auth_keepalive.stop_nous_auth_keepalive", lambda: None)
