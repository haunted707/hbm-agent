"""Tests for _setup_feishu() in hbm_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("hbm_cli.config.save_env_value", side_effect=mock_save), \
         patch("hbm_cli.config.get_env_value", side_effect=mock_get), \
         patch("hbm_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("hbm_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("hbm_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("hbm_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("hbm_cli.cli_output.print_header"), \
         patch("hbm_cli.cli_output.print_info"), \
         patch("hbm_cli.cli_output.print_success"), \
         patch("hbm_cli.cli_output.print_warning"), \
         patch("hbm_cli.cli_output.print_error"), \
