...
class TestTrimError:
    ...
    def test_file_not_found_path_collapsed_to_filename(self):
        long_path = "File not found: /home/teknium/.hbm/hbm-agent/very/deep/path/foo.py"
...
class TestDetectToolFailureTerminal:
    ...
    def test_degraded_backend_shows_full_reason_and_retry_hint(self):
        ...
        result = json.dumps({
            ...
            "retry_hint": "Start Docker, or run `hbm-agent setup terminal` to switch to Local, then retry",
        ...
        assert "hbm-agent setup terminal" in suffix
