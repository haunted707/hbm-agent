...
from hbm_logging import clear_session_context, set_session_context
...
class TestHealStatsSurface:
    ...
    def test_debug_report_includes_heal_counters(self, monkeypatch):
        import agent.agent_runtime_helpers as arh
        from hbm_cli.debug import collect_debug_report, LogSnapshot
