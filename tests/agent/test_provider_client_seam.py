...
def test_skip_flags_replace_the_isinstance_checks_for_in_and_out_of_tree_clients():
    ...
    assert CopilotACPClient.HBM_SKIP_TRANSPORT_WRAP and CopilotACPClient.HBM_SKIP_ASYNC_WRAP
    assert GeminiNativeClient.HBM_SKIP_TRANSPORT_WRAP
    assert not getattr(GeminiNativeClient, "HBM_SKIP_ASYNC_WRAP", False)
