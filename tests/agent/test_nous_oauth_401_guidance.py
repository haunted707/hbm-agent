...
to a generic "Your API key was rejected... run hbm setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "hbm setup".
    assert "hbm portal" in source
