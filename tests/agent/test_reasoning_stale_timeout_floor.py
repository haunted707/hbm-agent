...
thinking phase.  HBM AGENT's default cloud-stream stale detector
(``HBM_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``HBM_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
