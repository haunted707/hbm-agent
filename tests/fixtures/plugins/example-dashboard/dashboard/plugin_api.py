...
part of the bundled-plugins set; a stock hbm-agent install does not see
an "Example" tab in its sidebar. The ``_install_example_plugin`` pytest
fixture in ``tests/hbm_cli/test_web_server.py`` copies this directory
into ``$HBM_HOME/plugins/example-dashboard/`` and forces the dashboard
