...
class TestSlackSyntheticThreadCapture:
    def test_synthetic_slack_thread_not_captured(self):
        ...
        env = {
            "HBM_SESSION_PLATFORM": "slack",
            "HBM_SESSION_CHAT_ID": "D0BJTDCSR7C",
            "HBM_SESSION_THREAD_ID": "1755043010.123456",
            "HBM_SESSION_MESSAGE_ID": "1755043010.123456",
        }
    ...
    def test_genuine_slack_thread_preserved(self):
        ...
        env = {
            "HBM_SESSION_PLATFORM": "slack",
            "HBM_SESSION_CHAT_ID": "C0AGENERAL",
            "HBM_SESSION_THREAD_ID": "1755040000.000100",
            "HBM_SESSION_MESSAGE_ID": "1755043010.123456",
        }
        with _session_env(env):
            origin = _origin_from_env()
    ...
    def test_non_slack_platform_thread_untouched(self):
        ...
        env = {
            "HBM_SESSION_PLATFORM": "telegram",
            "HBM_SESSION_CHAT_ID": "-1003941067111",
            "HBM_SESSION_THREAD_ID": "2203",
            "HBM_SESSION_MESSAGE_ID": "2203",
        }
        with _session_env(env):
            origin = _origin_from_env()
        assert origin is not None
