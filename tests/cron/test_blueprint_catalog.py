...
the shared /blueprint command handler (hbm_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated HBM_HOME for anything that touches the
cron job store.
"""
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("hbm://blueprint/morning-brief?")
