...
Run before any catalog commit:
    ...
    HBM_TEST_NETWORK=1 scripts/run_tests.sh tests/hbm_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("HBM_TEST_NETWORK"),
    reason="network test; set HBM_TEST_NETWORK=1 to run",
)
