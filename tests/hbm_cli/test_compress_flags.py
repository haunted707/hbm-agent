...
Covers the pure helpers in ``hbm_cli.partial_compress`` plus alias
...
from hbm_cli.commands import COMMANDS, resolve_command
from hbm_cli.partial_compress import (
    DEFAULT_KEEP_LAST,
