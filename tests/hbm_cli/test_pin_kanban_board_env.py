...
def _isolate_kanban_board_env():
    """Snapshot `HBM_KANBAN_BOARD` and restore it after the test.
    ...
    """
    prev = os.environ.get("HBM_KANBAN_BOARD")
...
def test_pin_does_not_overwrite_existing_env(monkeypatch):
    ...
    assert main_mod.os.environ.get("HBM_KANBAN_BOARD") == "preset"
