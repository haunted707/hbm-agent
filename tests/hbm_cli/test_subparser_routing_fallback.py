...
The main() function in hbm_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `hbm -c model`
...
def _build_parser():
    """Build a minimal replica of the hbm top-level parser."""
