"""Tests for the interactive session browser (`hbm-agent sessions browse`).
...
from hbm_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """hbm-agent sessions browse should be parseable."""
