...
the *mutation* side: `hbm-agent plugins enable/disable` must resolve a bare name
...
class TestEnableDisableNested:
    @patch("hbm_cli.plugins.get_bundled_plugins_dir")
    @patch("hbm_cli.plugins_cmd._plugins_dir")
    @patch("hbm_cli.plugins_cmd._save_disabled_set")
    @patch("hbm_cli.plugins_cmd._save_enabled_set")
    @patch("hbm_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("hbm_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestEnableToolOverrideConsent:
    ...
    @patch("hbm_cli.plugins.get_bundled_plugins_dir")
    @patch("hbm_cli.plugins_cmd._plugins_dir")
    @patch("hbm_cli.plugins_cmd._set_plugin_entry_flag")
    @patch("hbm_cli.plugins_cmd._save_disabled_set")
    @patch("hbm_cli.plugins_cmd._save_enabled_set")
    @patch("hbm_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("hbm_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestCompositeMenuWritesCanonicalKey:
    """#40190 follow-up: the interactive `hbm plugins` menu must persist
    ...
    def test_fallback_unchecked_plugin_disables_by_key_not_name(
        ...
        from hbm_cli.plugins_cmd import _run_composite_fallback
