...
Every surface renders through ``hbm_cli.status_report.build_status_fields``; each keeps
...
def test_three_status_surfaces_report_the_same_common_fields():
    with patch("hbm_constants.display_hbm_home", return_value=HOME), \
