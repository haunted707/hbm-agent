...
import hbm_cli.macos_tcc_anchor as tcc
...
class TestUvStoreDetection:
    ...
    def test_matches_hbm_runtime_repair_generation(self):
        path = (
            "/Users/u/hbm-agent/.hbm-runtime/python/"
...
class TestEnsureTccAnchor:
    ...
    def test_store_root_marker_tracks_managed_uv_constant(self):
        ...
        from hbm_cli.managed_uv import _RUNTIME_DIR_NAME
