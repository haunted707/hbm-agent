...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (hbm_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_hbm_overlays():
    """hbm_cli.providers.get_provider("vertex") backs
