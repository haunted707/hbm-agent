...
from hbm_cli.dashboard_auth import refresh_singleflight as replay
from hbm_cli.dashboard_auth.base import ProviderError, RefreshExpiredError, Session
from hbm_cli.dashboard_auth.routes import router
...
def test_cookie_gate_burst_with_stale_rt_rotates_once(gated_web_app):
    ...
    cookies = {"hbm_session_at": "expired-at", "hbm_session_rt": "stale-rt",
               "hbm_session_provider": "stub"}
