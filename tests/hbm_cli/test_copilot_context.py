...
class TestGetCopilotModelContext:
    ...
    @patch("hbm_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("hbm_cli.models._urlopen_model_catalog_request")
    ...
    @patch("hbm_cli.models.fetch_github_model_catalog", return_value=[])
