...
import hbm_cli.model_switch_providers as hbm_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(hbm_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("hbm_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import hbm_cli.models as hm
    import hbm_cli.models_catalog_static as hbm_cli_models_catalog_static
    from hbm_cli import models_catalog_static
    ...
    monkeypatch.setattr(hbm_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
