...
from hbm_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/hbm_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("hbm_cli.lifecycle.invoke_hook")
@patch("hbm_cli.lifecycle.finalize_session")
