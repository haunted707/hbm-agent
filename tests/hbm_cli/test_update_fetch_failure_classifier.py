"""Fetch-failure classification for `hbm update` / `hbm update --check`.
...
def test_update_network_git_calls_never_prompt_for_credentials():
    ...
    Live incident (Sep 2026): a GitHub-side 401 made `hbm update` sit on
    ...
    from hbm_cli import update_cmd_git
