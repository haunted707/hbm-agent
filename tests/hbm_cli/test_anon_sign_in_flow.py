...
from hbm_cli.auth_constants import AuthError
from tests.hbm_cli.test_anon_upgrade import (  # noqa: F401  (fixtures used by name)
...
def test_already_signed_in_short_circuits_before_any_network(portal):
    from hbm_cli.auth import _load_auth_store, _save_auth_store, _save_provider_state
