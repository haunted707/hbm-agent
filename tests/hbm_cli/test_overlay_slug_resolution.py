...
HBM_OVERLAYS keys may be models.dev IDs (e.g. "github-copilot") while
_PROVIDER_MODELS and config.yaml use HBM AGENT IDs ("copilot").  The slug
...
def test_copilot_uses_hbm_slug():
