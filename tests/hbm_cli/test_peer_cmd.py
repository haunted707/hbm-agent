...
from hbm_cli.subcommands import peer as peer_cmd
...
class _FakePeer(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if self.path == "/api/sessions":
            ...
            return self._json({"object": "hbm.session", "session": {"id": "bc_1", "title": body.get("title")}}, 201)
...
# ── per-turn author (HBM_TURN_AUTHOR set by the message_agent runner) ─────
