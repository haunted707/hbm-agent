"""Tests for `hbm secrets bitwarden token` / `hbm secrets onepassword token`.
...
from hbm_cli import onepassword_secrets_cli as op_cli
from hbm_cli import secrets_cli as bw_cli
