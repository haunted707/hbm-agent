"""Tests for `_can_open_graphical_browser()` in hbm_cli.auth.

Guards the fix for the May 2026 report where `hbm auth add xai-oauth`
...
from hbm_cli.auth import _can_open_graphical_browser
