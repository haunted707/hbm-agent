...
only when every damaged object is an HBM AGENT FTS shadow.
"""
...
from hbm_cli.doctor_state import _state_db_health
from hbm_state import SessionDB
from hbm_state_repair import integrity_damage_is_structural, state_db_has_structural_damage
