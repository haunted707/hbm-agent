...
import hbm_cli.models_pricing as mp
...
def test_nous_picker_model_ids_reads_pricing_cache_only(monkeypatch):
    ...
    monkeypatch.setattr("hbm_cli.models.check_nous_free_tier", lambda **kw: False)
    monkeypatch.setattr("hbm_cli.models.fetch_nous_recommended_models", lambda *a, **kw: None)
