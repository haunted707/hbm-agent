...
class TestTimezoneValidation:
    ...
    schedule on server-local time (hbm_time._get_zoneinfo falls back with
    ...
    def test_invalid_or_non_string_zone_is_an_error(self):
        ...
        assert "IANA" in issue.hint and "HBM_TIMEZONE" in issue.hint
...
class TestUnknownTopLevelKeys:
    ...
    (gateway/run.py, hbm send) so users can feed skills and external apps
