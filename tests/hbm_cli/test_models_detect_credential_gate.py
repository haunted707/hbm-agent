...
def authed(monkeypatch):
    ...
    from hbm_cli import models_detect
...
class TestNoCredentialsNoSwitch:
    ...
    def test_explicitly_named_provider_is_not_gated(self, no_live_catalog, authed, monkeypatch):
        ...
        monkeypatch.setattr(models, "detect_static_provider_for_model", lambda n, c: ("nous", "hbm-4-405b"))
        assert models.detect_provider_for_model("nous", "deepseek") == ("nous", "hbm-4-405b")
