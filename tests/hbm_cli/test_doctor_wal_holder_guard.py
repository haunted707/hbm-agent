"""Regression: ``hbm doctor --fix`` must not checkpoint the live WAL under a running gateway.
...
# that depend on HBM AGENT *choosing* WAL mode (declined on vulnerable SQLite
