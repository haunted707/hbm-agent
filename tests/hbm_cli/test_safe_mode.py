"""Tests for `hbm chat --safe-mode` isolation."""
...
_VARS = ("HBM_SAFE_MODE", "HBM_IGNORE_USER_CONFIG", "HBM_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["HBM_SAFE_MODE"] == "1"
        assert os.environ["HBM_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["HBM_IGNORE_RULES"] == "1"
        return True
