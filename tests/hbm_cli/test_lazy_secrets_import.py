"""Regression test: hbm update must not load cryptography eagerly."""
...
assert 'hbm_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running hbm update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so hbm_cli is importable,
