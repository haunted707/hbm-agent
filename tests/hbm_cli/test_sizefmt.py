"""Tests for the shared byte formatter (hbm_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from hbm_cli.backup import _format_size as backup
    from hbm_cli.checkpoints import _fmt_bytes as checkpoints
    from hbm_cli.sizefmt import format_bytes as doctor
