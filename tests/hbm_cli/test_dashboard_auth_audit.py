...
Profile-aware location: ``$HBM_HOME/logs/dashboard-auth.log``.
...
from hbm_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $HBM_HOME and ~ to a tmp dir for the duration of the test."""
    home = tmp_path / ".hbm"
    home.mkdir()
