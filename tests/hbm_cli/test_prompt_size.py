"""Tests for the ``hbm prompt-size`` diagnostic (issue #34667)."""
...
from hbm_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(hbm_home, memory_text="", user_text=""):
    mem_dir = hbm_home / "memories"
...
def _seed_skill(hbm_home, name, description):
    skill_dir = hbm_home / "skills" / "demo" / name
