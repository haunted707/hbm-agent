...
``[diff "x"] command=/textconv=`` driver. HBM AGENT gathers workspace context by
...
context-gathering git path HBM AGENT runs neutralizes every sink. They use a real
