...
def _quiet_switch(monkeypatch):
    ...
    monkeypatch.setattr("hbm_cli.model_switch.switch_model", lambda **_kw: result)
    monkeypatch.setattr("hbm_cli.model_switch.persist_model_selection", lambda _r: None)
    monkeypatch.setattr("hbm_cli.model_cost_guard.expensive_model_warning", lambda *a, **k: None)
