...
must match regardless of host OS (a Linux-hosted HBM AGENT can still drive a
...
class TestWindowsPathVariant:
    ...
    @pytest.mark.parametrize("cmd", [
        ...
        r"copy C:\Users\me\AppData\Local\hbm\.env D:\exfil\e.txt",
        "cat C:/Users/me/AppData/Local/hbm/.env",
    ])
