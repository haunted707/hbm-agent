...
hardcoded "~/.hbm/scripts/" in its messages even though resolution goes
through get_hbm_home(), which is per-profile.
"""
...
class TestValidateCronScriptPath:
    ...
    def test_missing_file_error_names_the_resolved_scripts_dir(self):
        ...
        # under profiles, where get_hbm_home() is not the global ~/.hbm.
        scripts_dir = get_hbm_home() / "scripts"
