...
def _ensure_redaction_enabled(monkeypatch):
    """Ensure redaction is active regardless of host HBM_REDACT_SECRETS."""
...
class TestBrowserSecretExfil:
    ...
    def test_cloud_browser_allows_credential_named_query_param(self):
        ...
        session's cookies and typed passwords. Only HBM AGENT-secret-shaped values stay blocked."""
        from tools.browser_tool import browser_navigate
...
class TestWebExtractSecretExfil:
    ...
    async def test_allows_credential_named_query_param(self):
        ...
        Only HBM AGENT-secret-shaped VALUES are blocked (see test_blocks_api_key_in_url)."""
        from tools.web_tools import web_extract_tool
    ...
    async def test_allows_ambiguous_english_word_query_param(self):
        ...
        for url in (
            ...
            "https://github.com/search?q=hbm&code=1",
