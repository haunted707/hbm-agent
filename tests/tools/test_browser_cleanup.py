    ...
    def test_extracts_quoted_absolute_path(self):
        ...
        assert (
            _extract_screenshot_path_from_text(
                "Screenshot saved to '/Users/david/.hbm/browser_screenshots/shot.png'"
            )
            == "/Users/david/.hbm/browser_screenshots/shot.png"
        )
...
class TestInactivityJanitorMultiplex:
    ...
    def test_janitor_tears_down_under_owner_profile_scope(self, tmp_path, monkeypatch):
        ...
        from hbm_constants import (
            get_hbm_home, reset_hbm_home_override, set_hbm_home_override,
        )
        ...
        home_tok = set_hbm_home_override(str(p1))
