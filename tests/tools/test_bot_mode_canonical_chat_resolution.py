...
apps/desktop/src/plugins/hbm-bots/canonical-chat-registry.test.ts; here we pin the DB/RPC algebra
...
def home(tmp_path, monkeypatch):
    """Temp HBM_HOME so the gateway resolvers read a throwaway state.db.
