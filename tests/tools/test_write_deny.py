...
class TestWriteDenyExactPaths:
    ...
    def test_hbm_root_env_when_running_under_profile(self, tmp_path, monkeypatch):
        ...
        ``~/.hbm/.env`` (whose credentials are inherited by every profile)
        ...
        # Sanity check: HBM_HOME does point to the profile dir, not the root.
        from hbm_constants import get_hbm_home, get_default_hbm_root
...
class TestWriteAllowed:
    ...
    def test_hbm_control_files_requested_writable(self):
