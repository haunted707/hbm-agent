...
A gateway sets HBM_EXEC_ASK=1 at startup and hands its environ to every external cron
worker; interactive launches export HBM_INTERACTIVE=1. Inside cron nobody can answer the
