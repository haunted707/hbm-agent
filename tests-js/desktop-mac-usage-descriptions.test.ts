 ...
 *
 * Each entry is a key/value pair that lands in the packaged HBM AGENT.app's
 ...
 * "HBM AGENT wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("HBM AGENT wants to access Music" when HBM AGENT never touches the Music
