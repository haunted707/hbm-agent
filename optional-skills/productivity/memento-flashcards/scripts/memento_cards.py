...
Data file: $HBM_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_HBM_HOME = Path(os.environ.get("HBM_HOME", Path.home() / ".hbm"))
DATA_DIR = _HBM_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
