...
Standard library only, so it runs in any HBM AGENT environment without an install
...
USER_AGENT = "hbm-agent/1.0 (rss-feeds skill; +https://github.com/NousResearch/hermes-agent)"
TIMEOUT = 20
NS = {
