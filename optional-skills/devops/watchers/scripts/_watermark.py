...
def _state_dir() -> Path:
    ...
    # Default: $HBM_HOME/watcher-state/, falling back to ~/.hbm/watcher-state/.
    hbm_home = os.environ.get("HBM_HOME") or str(Path.home() / ".hbm")
    return Path(hbm_home) / "watcher-state"
