# nix/overlays.nix — Expose pkgs.hbm-agent for external NixOS configs
#
...
# `pkgs.hbm-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    hbm-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
