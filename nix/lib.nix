      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via HBM_BUNDLED_SKILLS /
            # HBM_OPTIONAL_SKILLS (see hbm-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + HBM_BUNDLED_LOCALES
            # / HBM_OPTIONAL_MCPS, not via the wheel. Excluding them
