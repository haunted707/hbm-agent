"""HBM AGENT skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces HBM_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces HBM_CADUCEUS)
...
# Branding shared by every HBM AGENT-named built-in (mono/daylight override help_header).
_HBM_BRANDING: Dict[str, str] = _branding(
    "HBM AGENT", "☤", "Goodbye! ☤", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Classic HBM AGENT — gold and kawaii",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_HBM_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _HBM_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
...
def _routed_home_key() -> Optional[str]:
    ...
    return None if get_hbm_home_override() is None else hbm_home_key()
