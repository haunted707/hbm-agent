"""Slash command registry for the HBM AGENT CLI and gateway.
...
from hbm_constants import INDICATOR_STYLES
...
class CommandDef:
    ...
    # Key in ``hbm_cli.slash_exec.EXECUTORS`` (a string, not a callable: keeps this module
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("snapshot", "Create or restore state snapshots of HBM AGENT config/state", "Session",
    ...
    CommandDef("goal", "Set a standing goal HBM AGENT works on across turns until achieved", "Session",
    ...
    CommandDef("plan", "Write a markdown implementation plan to .hbm/plans/ without executing anything", "Session",
               args_hint="[task]"),
    ...
    CommandDef("wake", "Toggle the 'Hey HBM AGENT' wake word listener", "Configuration",
               cli_only=True, args_hint="[on|off|status]", subcommands=("on", "off", "status")),
    CommandDef("busy", "Control how messages behave while HBM AGENT is working", "Configuration",
    ...
    CommandDef("reload-skills", "Re-scan ~/.hbm/skills/ for newly installed or removed skills",
    ...
    CommandDef("update", "Update HBM AGENT to the latest version", "Info",
               busy_policy="dispatch", desktop="terminal"),
    CommandDef("version", "Show HBM AGENT version", "Info", aliases=("v",),
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'discord_skill_commands_by_category': ('hbm_cli.commands_platforms', 'discord_skill_commands_by_category'),
    'slack_app_manifest': ('hbm_cli.commands_platforms', 'slack_app_manifest'),
    'slack_native_slashes': ('hbm_cli.commands_platforms', 'slack_native_slashes'),
    'slack_subcommand_map': ('hbm_cli.commands_platforms', 'slack_subcommand_map'),
    'telegram_bot_commands': ('hbm_cli.commands_platforms', 'telegram_bot_commands'),
    'telegram_menu_commands': ('hbm_cli.commands_platforms', 'telegram_menu_commands'),
    'telegram_menu_max_commands': ('hbm_cli.commands_platforms', 'telegram_menu_max_commands'),
}
