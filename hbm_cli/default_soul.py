"""Default SOUL.md template seeded into HBM_HOME on first run."""
...
DEFAULT_SOUL_MD = (
    "You are HBM AGENT, built by Nous Research. Be direct: match the length of your reply to the weight of "
...
_SCAFFOLD_HEAD = (
    ...
    "The agent will embody whatever you write here.\nEdit this to customize how HBM AGENT communicates with you.\n\n"
)
_SCAFFOLD_TAIL = (
...
_LEGACY_TEMPLATE_SOULS = (
    ...
    (
        "You are HBM AGENT, an intelligent AI assistant created by Nous Research. You are helpful, "
