...
:mod:`hbm_cli.commands` (which re-exports both classes) so the registry module stays
...
from hbm_cli.commands import COMMANDS, SUBCOMMANDS
...
def _personality_completions(sub_text: str, sub_lower: str):
    ...
    from hbm_cli.personality import describe_personality
