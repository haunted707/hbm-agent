...
Split out of ``hbm_cli.models``. The detection ladder there consults static catalogs, then the
...
def current_provider_catalog_match(model_name: str, current_provider: str) -> Optional[str]:
    ...
    Goes through :func:`hbm_cli.models.cached_provider_model_ids` (1h TTL, stale-while-
    ...
    from hbm_cli.models import cached_provider_model_ids, normalize_provider
...
def current_provider_owns_vendor(model_name: str, current_provider: str) -> bool:
    ...
    from hbm_cli.model_normalize import detect_vendor
    from hbm_cli.models import _AGGREGATOR_PROVIDERS, _PROVIDER_MODELS, normalize_provider
