...
Mirrors ``hbm_cli/kanban_specify.py``: lazy aux client import, lenient response parse,
...
_SYSTEM_PROMPT = """You are a profile-describer for the HBM AGENT kanban board.
...
Rules:
  ...
  - Never write "HBM AGENT profile" or other meta-narration.
...
def _extract_json_blob(raw: str) -> Optional[dict]:
    from hbm_cli.kanban_specify import _extract_json_blob as _extract
