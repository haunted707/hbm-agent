"""``hbm-agent import`` subcommand parser."""
...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import", help="Restore a HBM AGENT backup from a zip file",
        description="Extract a previously created HBM AGENT backup into your "
        "HBM AGENT home directory, restoring configuration, skills, "
        "sessions, and data")
