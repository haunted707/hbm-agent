...
def build_migrate_parser(subparsers) -> None:
    ...
    from hbm_cli.migrate import cmd_migrate, cmd_migrate_xai
    ...
    migrate_relay = migrate_subparsers.add_parser(
        "relay", help="Convert legacy HBM_NEMO_RELAY_ATIF_*/ATOF_* exporter vars into relay-plugins.toml",
...
def _cmd_migrate_relay(args) -> None:
    from hbm_cli.relay_plugin_migrate import cmd_migrate_relay
