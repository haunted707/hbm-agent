...
def _cu_install(args) -> int:
    from hbm_cli.tools_config import _cua_driver_contract_status, install_cua_driver
...
def _cu_status(args) -> int:
    import os as _os
    import subprocess
    from hbm_cli.tools_config import _cua_driver_contract_status
    ...
    version = ""
    try:
        from hbm_cli.tools_config import _cua_driver_env
...
def build_computer_use_parser(subparsers) -> None:
    ...
    computer_use_perms = computer_use_sub.add_parser(
        ...
        description="Computer Use drives the Mac through cua-driver, whose TCC grants\n"
            ...
            "terminal or the HBM AGENT app. `status` reports the driver's grant\n"
