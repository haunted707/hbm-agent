...
class CLIModalMixin:
    ...
    def _build_command_palette_entries(self) -> list:
        ...
        from hbm_cli.commands import COMMANDS_BY_CATEGORY
    ...
    def _ring_bell(self, prompt: bool = False, context: str = "", detail: str = "") -> None:
        ...
        if not getattr(self, flag, False) or getattr(self, "_terminal_io_broken", False):
            return
        from hbm_cli.cli_terminal_mixin import _run_on_app_loop, _write_terminal_sequence
        from hbm_cli.terminal_notify import notification_sequence, write_tty
