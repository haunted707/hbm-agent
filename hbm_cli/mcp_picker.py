...
from hbm_cli.colors import Colors
from hbm_cli.cli_output import prompt_yes_no
from hbm_cli.curses_ui import curses_single_select
from hbm_cli.mcp_catalog import (
...
def _enable_disable(name: str, *, enable: bool) -> None:
    ...
    _say(
        ...
        "Start a new HBM AGENT session for changes to take effect."
    )
...
def _configure_tools(name: str) -> None:
    ...
    from hbm_cli.mcp_config import cmd_mcp_configure
