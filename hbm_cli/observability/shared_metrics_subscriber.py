"""Relay subscriber for the persisted HBM AGENT shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated HBM AGENT counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the HBM AGENT shared metric: %s", metric_name, exc_info=True
                )
