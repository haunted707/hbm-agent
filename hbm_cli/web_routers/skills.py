...
from hbm_cli.web_server_profiles import _hub_action_name, _installed_hub_identifiers
...
def _resolve_hub_skill(ident: str, profile: Optional[str]):
    ...
    from hbm_cli.skills_hub import _resolve_source_meta_and_bundle
    from tools.skills_hub_search import create_source_router
...
# Sources subsumed by an available hbm-index (progressive per-source fan-out
