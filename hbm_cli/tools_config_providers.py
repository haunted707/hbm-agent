...
from hbm_cli.config import cfg_get, get_env_value, load_config, save_config, save_env_value
from hbm_cli.nous_account import format_nous_portal_entitlement_message
from hbm_cli.nous_subscription import MANAGED_FEATURE_COVERAGE_CATEGORY, NousSubscriptionFeatures
...
def _plugin_registry(module: str):
    ...
    try:
        ...
        from hbm_cli.plugins import _ensure_plugins_discovered
...
def _visible_providers(
    ...
    from hbm_cli.tools_config import get_nous_subscription_features
...
def _toolset_needs_configuration_prompt(ts_key: str, config: dict, *, force_fresh: bool = False) -> bool:
    ...
    from hbm_cli.tools_config import TOOL_CATEGORIES, _post_setup_already_installed, _toolset_has_keys
...
def _configure_tool_category(ts_key: str, cat: dict, config: dict, *, force_fresh: bool = True, reconfigure: bool = False):
    ...
    from hbm_cli.tools_config import _prompt_choice, _provider_env_ready, get_nous_subscription_features
...
def _detect_active_provider_index(providers: list, config: dict, *, force_fresh: bool = False) -> int:
    ...
    from hbm_cli.tools_config import _provider_env_ready
...
def _select_into(config: dict, section: str, key: str, vendor, managed) -> dict:
    ...
    from hbm_cli.tools_config import _cfg_section
...
def _nous_provider_gate(provider: dict, config: dict, managed_feature, *, force_fresh: bool) -> bool:
    ...
    if managed_feature:
        from hbm_cli.nous_subscription import ensure_nous_portal_access
...
def _show_portal_hint(provider: dict, config: dict, managed_feature, force_fresh: bool) -> bool:
    ...
    from hbm_cli.tools_config import TOOL_CATEGORIES, get_nous_subscription_features
...
def _configure_simple_requirements(ts_key: str, *, reconfigure: bool = False):
    ...
    from hbm_cli.tools_config import TOOLSET_ENV_REQUIREMENTS, _toolset_has_keys, _toolset_label
