...
from hbm_cli.kanban_db_graph import decompose_triage_task
from hbm_cli import kanban_db_connect as kbc
from hbm_cli import profiles as profiles_mod
from hbm_cli.kanban_specify import (
    _call_aux, _extract_json_blob, _load_triage_task, _task_prompt_fields, _title_body,
)
from hbm_cli.kanban_specify import _profile_author as _specify_author

logger = logging.getLogger(__name__)


_SYSTEM_PROMPT = """You are the Kanban decomposer for the HBM AGENT board.
...
def _profile_author() -> str:
    """Mirror of ``hbm_cli.kanban._profile_author``."""
