...
from hbm_cli.local_runtime.binaries import server_binary, runtimes_root
from hbm_cli.local_runtime.processes import spawn_server
...
def state_path() -> Path:
    """Endpoint state for other HBM AGENT processes (provider resolution routes llamacpp-alias
...
class LlamaServerSupervisor:
    """Own one llama-server router process for the life of a HBM AGENT session."""
