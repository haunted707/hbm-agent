"""Non-interactive HTTPS credentials for HBM AGENT's internal git clones (private plugin/MCP/profile repos).
...
repo the user can already clone from their shell fails inside ``hbm-agent plugins install`` with
