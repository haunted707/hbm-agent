"""Shared migration guards for HBM AGENT' native NeMo Relay ownership."""
...
RELAY_PLUGINS_CONFIG_ENV = "HBM_NEMO_RELAY_PLUGINS_TOML"

LEGACY_RELAY_PLUGIN_KEYS = frozenset({"nemo_relay", "observability/nemo_relay"})

LEGACY_RELAY_EXPORT_ENV_VARS = frozenset({
    "HBM_NEMO_RELAY_ATOF_ENABLED",
    "HBM_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY",
    "HBM_NEMO_RELAY_ATOF_FILENAME",
    "HBM_NEMO_RELAY_ATOF_MODE",
    "HBM_NEMO_RELAY_ATIF_ENABLED",
    "HBM_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY",
    "HBM_NEMO_RELAY_ATIF_FILENAME_TEMPLATE",
    "HBM_NEMO_RELAY_ATIF_AGENT_NAME",
    "HBM_NEMO_RELAY_ATIF_AGENT_VERSION",
    "HBM_NEMO_RELAY_ATIF_EXPORT_TIMEOUT_S",
    "HBM_NEMO_RELAY_ATIF_MODEL_NAME",
    "HBM_NEMO_RELAY_ATIF_SUBAGENT_EXPORT_MODE",
})
