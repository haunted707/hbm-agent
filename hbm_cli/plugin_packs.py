    ...
    for entry in pack.plugins:
        ...
        try:
            if catalog_entries is None:
                from hbm_cli.plugin_catalog import load_catalog_live
...
def export_pack(*, enabled_only: bool = False, pack_name: str = "my-hbm-pack") -> tuple[str, List[str]]:
    ...
    import yaml
    from hbm_cli.plugins_cmd import _get_enabled_set, _plugins_dir, _read_install_metadata
...
_PACK_ACTIONS = {
    ...
    "export": lambda args: cmd_pack_export(
        ...
        name=getattr(args, "name", None) or "my-hbm-pack"),
