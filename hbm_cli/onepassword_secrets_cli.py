...
def cmd_setup(args: argparse.Namespace) -> int:
    ...
    console.print(
        Panel.fit(
            ...
            "HBM AGENT resolves [cyan]op://vault/item/field[/cyan] references through your\n"
    ...
    if binary and not token_set:
        ...
        if who:
            ...
            console.print(
                ...
                "HBM AGENT will warn and skip 1Password on next startup.[/yellow]"
            )
    if not references:
        console.print(
...
def cmd_sync(args: argparse.Namespace) -> int:
    ...
    console.print(
        ...
        "[cyan]hbm[/cyan] invocation.  Re-run with [cyan]--apply[/cyan] to export "
...
_PLUGIN_COMPAT_LAZY = {
    'masked_secret_prompt': ('hbm_cli.secret_prompt', 'masked_secret_prompt'),
}
