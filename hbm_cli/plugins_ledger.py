...
reload / targeted unload unwind registries in reverse order. Mixed into :class:`hbm_cli.plugins.PluginManager`.
"""
...
from hbm_cli.plugins_loader import _plugin_home_scope
from hbm_cli.plugins_manifest import PluginManifest, manifest_key
...
class PluginLedgerMixin:
    ...
    def _dispose_registrations(self, registrations: List[PluginRegistration]) -> None:
        ...
        from hbm_cli.plugins import _PLUGINS_DEBUG
