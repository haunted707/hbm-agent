...
def _session_db_read_probe_statements() -> tuple:
    ...
    from hbm_state_schema import schema_read_probe_statements
...
def _open_session_db_at_path(db_path: Path, *, read_only: bool):
    ...
    from hbm_state import SessionDB, is_malformed_schema_error
...
def _maybe_run_skill_maintenance(started_at: float) -> None:
    ...
    if _check_gateway_running(get_hbm_home()):
        return
