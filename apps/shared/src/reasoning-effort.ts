/** HBM AGENT' reasoning levels, in ascending order — mirrors the backend's
 *  VALID_REASONING_EFFORTS (hbm_constants.py). `none` is not a level: it's
 *  thinking disabled. */
...
/** HBM AGENT' built-in level when neither the surface nor the profile config
