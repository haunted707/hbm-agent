/**
 * Canonical HBM AGENT skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$HBM_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`hbm_cli/skin_engine.py`),
 ...
 *   • CLI     → `hbm_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
