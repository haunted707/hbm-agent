...
cd apps/desktop
XCURSOR_SIZE=24 HBM_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/hbm-typing
# → /tmp/hbm-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/hbm-typing.before.heapsnapshot
# → /tmp/hbm-typing.after.heapsnapshot
```
