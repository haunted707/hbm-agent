...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\hbm\hbm-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@hbm/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@hbm/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@hbm/shared/color': path.resolve(__dirname, '../shared/src/color.ts'),
      '@hbm/shared': path.resolve(__dirname, '../shared/src'),
