 ...
 * plugins resolve `@hbm/plugin-sdk` through the vite alias; RUNTIME-loaded
...
// `sdk/runtime` — so a module-scope `{ __HBM_PLUGIN_SDK__: sdk, … }` is
...
// `Object.keys(GLOBALS.__HBM_PLUGIN_SDK__)` threw
...
function pluginNamespaces() {
  return {
    __HBM_PLUGIN_SDK__: sdk,
    __HBM_REACT__: React,
    __HBM_REACT_JSX__: jsxRuntime,
    __HBM_REACT_JSX_DEV__: jsxDevRuntime
  }
}
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@hbm/plugin-sdk': shimUrl('__HBM_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__HBM_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__HBM_REACT_JSX__'),
    react: shimUrl('__HBM_REACT__')
  }
