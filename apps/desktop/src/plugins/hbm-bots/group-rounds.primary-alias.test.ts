...
it('keeps qualified remote defaults distinct from the primary alias regardless of roster order', () => {
  const local: GroupMember = { name: 'default', handle: 'hbm', connectionId: 'local', sourceScoped: true }
