...
import { ackStoredSessionId, atom, haptic, host, markSessionUnreadFinished } from '@hbm/plugin-sdk'
 ...
 *  (hbm-agent#90102) and are discarded. Without `canonical_session` (older
