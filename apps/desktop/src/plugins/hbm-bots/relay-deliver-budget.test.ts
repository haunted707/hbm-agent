...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/hbm-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'hbm_cli/config_defaults.py'), 'utf8')
