...
import { type PluginLocaleBundles, type PluginTranslate, usePluginI18n } from '@hbm/plugin-sdk'
...
const en: BotsMessages = {
  roster: {
    ...
    rosterUnavailable: reason =>
      `Roster unavailable: ${reason}. If your gateway predates profiles.list, update HBM AGENT and restart the gateway.`,
    waitingForGateway:
  ...
  bot: {
    ...
    openAnotherChatUnsupported: 'Update HBM AGENT Desktop to open another Bot chat.',
    remoteConnectionsUnsupported: 'Update HBM AGENT Desktop to chat with bots on other connections.',
    openNeedsUpdateTitle: 'This bot lives on an older HBM AGENT',
    openNeedsUpdateMessage: connectionLabel => `Update ${connectionLabel}, then try again.`,
    openUnreachableTitle: 'HBM AGENT couldn’t reach the computer this bot runs on',
  ...
  tools: {
    skillsHub: 'HBM AGENT Skills Hub',
...
const ja: BotsMessages = {
  roster: {
    ...
    retryNow: '今すぐ再試行',
    rosterUnavailable: reason =>
      `名簿を取得できません: ${reason}。ゲートウェイが profiles.list より前の場合は、HBM AGENT を更新してゲートウェイを再起動してください。`,
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '別のボットチャットを開くには HBM AGENT Desktop を更新してください。',
    remoteConnectionsUnsupported: '他の接続上のボットとチャットするには HBM AGENT Desktop を更新してください。',
    openNeedsUpdateTitle: 'このボットは古い HBM AGENT 上で動いています',
    openNeedsUpdateMessage: connectionLabel => `${connectionLabel} を更新してから、もう一度お試しください。`,
    openUnreachableTitle: 'このボットが動いているコンピューターに HBM AGENT が接続できませんでした',
...
const zh: BotsMessages = {
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重试',
    rosterUnavailable: reason => `无法获取名单：${reason}。如果网关早于 profiles.list，请更新 HBM AGENT 并重启网关。`,
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '请更新 HBM AGENT Desktop 以打开另一个机器人聊天。',
    remoteConnectionsUnsupported: '请更新 HBM AGENT Desktop 以与其他连接上的机器人聊天。',
    openNeedsUpdateTitle: '这个机器人运行在较旧的 HBM AGENT 上',
    openNeedsUpdateMessage: connectionLabel => `请更新 ${connectionLabel}，然后重试。`,
    openUnreachableTitle: 'HBM AGENT 无法连接到运行这个机器人的电脑',
...
const zhHant: BotsMessages = {
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重試',
    rosterUnavailable: reason => `無法取得名單：${reason}。如果閘道早於 profiles.list，請更新 HBM AGENT 並重新啟動閘道。`,
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '請更新 HBM AGENT Desktop 以開啟另一個機器人聊天。',
    remoteConnectionsUnsupported: '請更新 HBM AGENT Desktop 以與其他連線上的機器人聊天。',
    openNeedsUpdateTitle: '這個機器人運行在較舊的 HBM AGENT 上',
    openNeedsUpdateMessage: connectionLabel => `請更新 ${connectionLabel}，然後再試一次。`,
    openUnreachableTitle: 'HBM AGENT 無法連線到運行這個機器人的電腦',
...
export function useBots(): BotsText {
  const t = usePluginI18n('hbm-bots')
