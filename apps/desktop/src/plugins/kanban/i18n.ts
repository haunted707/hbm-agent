...
export const en: KanbanMessages = {
  ...
  notify: {
    ...
    gaveUpBody: 'HBM AGENT couldn’t finish this task. Open Kanban to see why and reassign it.',
    crashedTitle: 'Task hit a problem — HBM AGENT will retry it automatically',
    timedOutTitle: 'Task took too long — HBM AGENT will retry it automatically',
...
const ja: KanbanMessages = {
  ...
  notify: {
    ...
    gaveUpBody: 'HBM AGENT はこのタスクを完了できませんでした。かんばんを開いて原因を確認し、再割り当てしてください。',
    crashedTitle: 'タスクで問題が発生 — HBM AGENT が自動で再試行します',
    timedOutTitle: 'タスクに時間がかかりすぎました — HBM AGENT が自動で再試行します',
    openKanban: 'かんばんを開く',
...
const zh: KanbanMessages = {
  ...
  notify: {
    ...
    gaveUpTitle: '任务已停止',
    gaveUpBody: 'HBM AGENT 无法完成这个任务。打开看板查看原因并重新分配。',
    crashedTitle: '任务遇到问题 — HBM AGENT 将自动重试',
    timedOutTitle: '任务耗时过长 — HBM AGENT 将自动重试',
    openKanban: '打开看板',
...
const zhHant: KanbanMessages = {
  ...
  notify: {
    ...
    gaveUpTitle: '任務已停止',
    gaveUpBody: 'HBM AGENT 無法完成這個任務。開啟看板查看原因並重新指派。',
    crashedTitle: '任務遇到問題 — HBM AGENT 將自動重試',
    timedOutTitle: '任務耗時過長 — HBM AGENT 將自動重試',
    openKanban: '開啟看板',
