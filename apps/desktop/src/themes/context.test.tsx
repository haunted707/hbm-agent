...
// The live-authoring loop: HBM AGENT writes/edits one skin file and every surface
...
describe('ThemeProvider ← backend skin sync', () => {
  ...
  it('paints a persisted backend skin once the connect-time seed makes it resolvable', () => {
    window.localStorage.setItem('hbm-desktop-theme-v2', 'bloomberg')
...
// here as a reference implementation; the shared @hbm/shared/color ladder
