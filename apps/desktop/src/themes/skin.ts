/**
 * HBM AGENT skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$HBM_HOME/skins/` (or a
 * built-in) resolved by `hbm_cli/skin_engine.py` and pushed to every surface
 ...
 * skin HBM AGENT authors from a prompt lights up all three surfaces from one file.
 *
...
import { ensureContrast, mix } from '@hbm/shared/color'
import type { HbmSkin, SkinColors } from '@hbm/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: HbmSkin): DesktopTheme | null {
