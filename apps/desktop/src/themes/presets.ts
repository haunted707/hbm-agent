...
import { THEME_PRESET_PALETTES } from '@hbm/shared'
...
/**
 * Nous — the canonical HBM AGENT desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays HBM AGENT's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical HBM AGENT desktop identity: GitHub's chrome carrying Nous
