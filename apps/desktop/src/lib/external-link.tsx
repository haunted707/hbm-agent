...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|hbm):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.hbmDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.hbmDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of HBM AGENT, and it is the surface the agent
