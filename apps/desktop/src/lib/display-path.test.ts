...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/hbm-agent')).toBe('~/www/hbm-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/hbm-agent')).toBe('hbm-agent')
    expect(pathLeaf('~/www/hbm-agent')).toBe('hbm-agent')
