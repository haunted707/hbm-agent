...
// (#73044). Exercises the REAL hbm + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/hbm')
...
const conn = (over: Partial<HbmConnection> = {}): HbmConnection =>
  ({
    authMode: 'oauth',
