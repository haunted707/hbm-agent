...
export function getMessagingPlatforms(profile?: null | string): Promise<MessagingPlatformsResponse> {
  return hbmApi<MessagingPlatformsResponse>({
...
export function updateMessagingPlatform(
  ...
  return hbmApi<MessagingPlatformUpdateResponse>({
    ...profileScoped(profile),
...
export function testMessagingPlatform(
  ...
  return hbmApi<MessagingPlatformTestResponse>({
    ...profileScoped(profile),
...
export function startTelegramOnboarding(
  ...
  return hbmApi<TelegramOnboardingStartResponse>({
    ...profileScoped(profile),
...
export function getTelegramOnboardingStatus(
  ...
  return hbmApi<TelegramOnboardingStatusResponse>({
    ...profileScoped(profile),
...
export function applyTelegramOnboarding(
  ...
  return hbmApi<TelegramOnboardingApplyResponse>({
    ...profileScoped(profile),
...
export function approvePairing(
  ...
  return hbmApi<{ ok: boolean; user: PairingUser }>({
    ...profileScoped(profile),
...
export function getWebhooks(): Promise<WebhooksResponse> {
  return hbmApi<WebhooksResponse>({
    ...profileScoped(),
    path: '/api/webhooks'
  })
}
...
export function enableWebhooks(): Promise<WebhookEnableResponse> {
  return hbmApi<WebhookEnableResponse>({
    ...profileScoped(),
...
export function createWebhook(body: WebhookCreatePayload): Promise<WebhookCreateResponse> {
  return hbmApi<WebhookCreateResponse>({
    ...profileScoped(),
    path: '/api/webhooks',
    method: 'POST',
    body
...
export function setWebhookEnabled(
  ...
  return hbmApi<{ enabled: boolean; name: string; ok: boolean }>({
    ...profileScoped(),
