...
const TAKEOVER_KEY = 'hbm.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which HBM AGENT can't clear via the API — the user
 *  sees exactly what runs instead of HBM AGENT silently deleting their creds. */
