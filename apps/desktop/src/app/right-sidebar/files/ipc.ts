...
import type { HbmReadDirEntry, HbmReadDirResult } from '@/global'
...
export type ProjectTreeEntry = HbmReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: HbmReadDirEntry) {
...
async function filterIgnored(entries: HbmReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<HbmReadDirResult> {
