import type { HbmReviewFile } from '@/global'
...
export function buildReviewFlatList(files: HbmReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: HbmReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
