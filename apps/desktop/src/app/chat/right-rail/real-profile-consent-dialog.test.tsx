...
vi.mock('@/hbm', () => ({
  saveHbmConfigRecord: (config: Record<string, unknown>, profile?: unknown) => mocks.save(config, profile)
}))

const promptCopy = {
  title: 'Stay signed in to your sites',
  body: 'Let HBM AGENT browse with a snapshot of your default browser profile.',
...
vi.mock('../../hooks/use-config-record', () => ({
  hbmConfigCacheWriter: () => (config: Record<string, unknown>) => mocks.cache(config),
  useHbmConfigRecord: () => ({ data: mocks.loadedConfig })
}))
