...
import { saveHbmConfigRecord } from '@/hbm'
...
export function RealProfileConsentDialog({ tabId }: RealProfileConsentDialogProps) {
  ...
  const { data: config } = useHbmConfigRecord()
  const setConfig = hbmConfigCacheWriter()
  ...
  const enable = useCallback(async () => {
    ...
    try {
      ...
      await saveHbmConfigRecord({ browser: { use_real_profile: true } })
