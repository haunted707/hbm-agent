...
const FOCUS_EVENT = 'hbm:composer-focus'
const INSERT_EVENT = 'hbm:composer-insert'
const ATTACH_IMAGES_EVENT = 'hbm:composer-attach-images'
const INSERT_REFS_EVENT = 'hbm:composer-insert-refs'
const SUBMIT_EVENT = 'hbm:composer-submit'
const VOICE_TOGGLE_EVENT = 'hbm:composer-voice-toggle'
const MODEL_MENU_EVENT = 'hbm:composer-model-menu'
