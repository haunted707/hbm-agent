...
import type { HbmGitBranch } from '@/global'
...
const branchActionLabel = (branch: HbmGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<HbmGitBranch[]>([])
  ...
  const convert = async (branch: HbmGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
