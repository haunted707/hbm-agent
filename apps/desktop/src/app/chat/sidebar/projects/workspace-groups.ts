...
import type { ProjectInfo, SessionInfo } from '@/hbm'
 ...
 * repo shows its branches/worktrees even when they have no HBM AGENT sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: HbmGitWorktree[]
): SidebarSessionGroup[] {
