...
import type * as HbmApi from '@/hbm'
...
vi.mock('@/hbm', async importOriginal => ({
  ...(await importOriginal<typeof HbmApi>()),
...
describe('SkillsView toolset management', { timeout: 60_000 }, () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'hbm-skill-pick', name: 'web-research', identifier: 'web-research' },
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { hbmDesktop?: unknown }).hbmDesktop = { connections, getAgentRoster }
