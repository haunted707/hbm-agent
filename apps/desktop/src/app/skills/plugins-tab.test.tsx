...
describe('PluginsTab', () => {
  ...
  it('renders a unified package as ONE row with a Desktop switch and an Agent switch', () => {
    $pluginRecords.set({
      media: { id: 'media', name: 'Media Studio', kind: 'disk', status: 'loaded', packageName: 'hbm-media-studio' }
    })
    $agentPlugins.set([
      {
        description: '',
        key: 'hbm-media-studio',
        name: 'hbm-media-studio',
        source: 'git',
        status: 'disabled',
        version: '1'
      }
