...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/hbm'
...
const VERSION = 3
const PREFIX = 'HML' // "HBM AGENT Memory Loadout" — namespaces our codes like WoW's leading bytes.
