import type { ModelOptionProvider, ModelOptionsResult } from '@hbm/shared'
import { DEFAULT_REASONING_EFFORT } from '@hbm/shared'
 ...
 * Returning `{}` is fine — the row then shows HBM AGENT' defaults.
 */
