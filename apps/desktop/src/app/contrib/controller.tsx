...
registry.registerMany([
  ...
  // The agent's write -> see loop: rescan <hbm home>/desktop-plugins
  ...
  // The keybind panel's non-titlebar door (the keyboard icon is gone).
  {
    ...
    data: {
      ...
      run: () => window.dispatchEvent(new CustomEvent('hbm:open-keybinds'))
    } satisfies PaletteContribution
  },
    ...
    >
      <ContribWiring>
        ...
        <div
          ...
          // [data-hbm-glass] rules in styles.css clear them so the tint
