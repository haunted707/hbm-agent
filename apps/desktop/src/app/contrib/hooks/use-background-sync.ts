...
import { getLatestSessionMessages, type ProfileScope } from '@/hbm'
...
interface BackgroundSyncParams {
  ...
  refreshHbmConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshHbmConfig])
}
