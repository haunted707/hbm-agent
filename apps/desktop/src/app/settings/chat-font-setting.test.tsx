...
vi.mock('@/hbm', () => ({
  saveHbmConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setHbmConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useHbmConfigRecord: () => ({ data: mocks.loadedConfig, dataUpdatedAt: mocks.configUpdatedAt })
}))
