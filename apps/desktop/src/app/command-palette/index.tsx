...
import { getHbmConfigRecord, listAllProfileSessions } from '@/hbm'
...
// HBM AGENT session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-hbm',
            keywords: ['update', 'upgrade', 'hbm', 'version', 'system', 'restart'],
            label: cc.updateHbm,
