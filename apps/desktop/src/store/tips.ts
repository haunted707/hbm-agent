 ...
 * - It covers HBM AGENT too. "Off" from someone who has just closed a bubble means
...
const ENABLED_KEY = 'hbm.desktop.tips.rotation.v1'

export const $tipsEnabled = persistentAtom(ENABLED_KEY, true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('hbm.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('hbm.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'hbm.desktop.tips.next.v1',
  null,
