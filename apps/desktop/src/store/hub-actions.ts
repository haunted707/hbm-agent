...
// `hbm skills install` exits non-zero when the security scan gate refuses,
...
// it. Two CLI shapes exist (`hbm_cli/skills_hub.py::_scan_block_message`):
//   current: "Not installed: the security scan found 2 high-risk pattern(s) in
//            'org/skill' (listed above). HBM AGENT never installs unverified
