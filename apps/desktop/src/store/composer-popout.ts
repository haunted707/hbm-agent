...
const POPOUT_STORAGE_KEY = 'hbm.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'hbm.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'hbm.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'hbm.desktop.composerPopout.position'
