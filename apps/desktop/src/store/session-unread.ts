...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('hbm.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('hbm.desktop.unreadFinishedSessions')
