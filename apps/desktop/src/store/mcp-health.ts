...
import { getHbmConfigRecord, type McpTestResult, setMcpServerEnabled, testMcpServer } from '@/hbm'
...
const SNOOZE_KEY_PREFIX = 'hbm:mcp-health-snooze-until:'
...
async function sweep(): Promise<void> {
  ...
  try {
    config = await getHbmConfigRecord()
  } catch {
