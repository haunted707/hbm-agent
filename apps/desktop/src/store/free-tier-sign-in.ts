...
import { cancelOAuthSession, listOAuthProviders, pollOAuthSession, startOAuthLogin } from '@/hbm'
...
// unreachable or refused mid sign-in (`hbm_cli/anon_sign_in.py`). Anything
...
/**
 * Drive one sign-in attempt end to end: resolve what identity this HBM AGENT is
