...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://hbm.example.com:8443/x')).toBe('hbm.example.com:8443')
    expect(remoteHostLabel('https://hbm.example.com:443')).toBe('hbm.example.com')
    expect(remoteHostLabel('http://hbm.example.com:80')).toBe('hbm.example.com')
  })
