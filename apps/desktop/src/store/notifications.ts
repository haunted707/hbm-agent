...
export const RECOVERY_ACTIONS = {
  restartHbm: (): NotificationAction => ({
    label: translateNow('notifications.actions.restartHbm'),
 ...
 *  (`hbm_state_errors.classify_persistence_error`). */
...
const ERROR_SUMMARIES: ErrorSummaryRule[] = [
  ...
  },
  {
    ...
    action: () => RECOVERY_ACTIONS.restartHbm()
  },
  {
