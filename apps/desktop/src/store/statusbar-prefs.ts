...
// v1 (`hbm.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'hbm.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'hbm.desktop.statusbarHidden'
// v1 (`hbm.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'hbm.desktop.statusbarVisible.v2'
