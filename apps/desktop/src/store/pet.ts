...
export interface PetInfo {
  ...
  // the HBM AGENT "run" activity state uses the in-place running row).
 ...
 * HBM_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'hbm.desktop.pet-roam.v1'
