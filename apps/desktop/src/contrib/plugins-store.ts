 ...
 * `<hbm home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'hbm.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'hbm.desktop.disabledPlugins.v1'
