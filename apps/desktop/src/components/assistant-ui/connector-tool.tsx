...
import type { ConnectionTargetState } from '@hbm/shared'
          ...
          const action =
            phase.verb === 'none'
              ...
              : {
                  ...
                  onClick: () => {
                    if (phase.verb === 'open' && target.connectUrl && window.hbmDesktop?.openExternal) {
                      void window.hbmDesktop.openExternal(target.connectUrl)
                    }
