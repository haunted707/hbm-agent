...
const STORAGE_KEY = 'hbm.desktop.layoutTree.v2'

writeKey('hbm.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('hbm.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('hbm.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'hbm.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'hbm.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'hbm.desktop.hiddenStripTabs.v1'
...
writeKey('hbm.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__HBM_LAYOUT_TREE__ = {
    close: closeTreePane,
