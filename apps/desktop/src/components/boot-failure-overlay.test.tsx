...
function failBoot() {
  $desktopBoot.set({
    error: 'Could not connect to HBM AGENT gateway',
    fakeMode: false,
    message: 'boot failed',
...
describe('BootFailureOverlay', () => {
  it('keeps keyboard focus inside the recovery surface', () => {
    ...
    const recoverySurface = screen.getByRole('dialog', { name: /HBM AGENT couldn't start/i })
