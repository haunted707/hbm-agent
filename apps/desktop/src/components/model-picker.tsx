import type { ModelOptionProvider, ModelPricing } from '@hbm/shared'
import { fuzzyRank, modelSearchText } from '@hbm/shared'
import { useQuery } from '@tanstack/react-query'
import { useEffect, useMemo, useState } from 'react'

import { getLocalModelsStatus } from '@/hbm'
...
import type { LocalModelLoadProgress } from '@/types/hbm'
...
export function ModelPickerDialog({
  ...
  // it: an empty query shows the curated list verbatim (like the `hbm
