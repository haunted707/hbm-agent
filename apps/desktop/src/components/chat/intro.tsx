...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should HBM AGENT look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} HBM AGENT need to see?`,
    ...
    {
      headline: `What should ${label} HBM AGENT tackle?`,
