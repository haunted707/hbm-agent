...
// Connectors are the apps HBM AGENT reads and acts on for the user. Chat channels
// (Discord, Telegram, WhatsApp) are how a user talks to HBM AGENT; those live on
