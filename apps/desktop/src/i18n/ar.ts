...
export const ar = defineLocale({
  sessionImport: {
    ...
    subtitle: 'انقل محادثة إلى HBM AGENT وتابع من حيث توقفت.',
    action: 'استيراد جلسة',
    ...
    chooseHelp: 'اختر جلسة لقراءة سجلها قبل نقلها إلى HBM AGENT.',
    ...
    you: 'أنت',
    snapshot: 'هذه المحادثة موجودة بالفعل في HBM AGENT. افتح نسختك الحالية للمتابعة.',
    copyNotice: 'ينسخ نص المحادثة دون تغيير الملفات الأصلية. لا يشمل مخرجات الأدوات أو الاستدلال.',
    importing: 'جارٍ الاستيراد…',
    open: 'فتح في HBM AGENT',
    continue: 'المتابعة في HBM AGENT',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'يمكنك أيضاً تشغيل `hbm debug share --nous` من الطرفية، أو `hbm debug share --local` لعرض التقرير دون رفعه.',
  ...
  boot: {
    ready: 'HBM AGENT Desktop جاهز',
    desktopBootFailedWithMessage: message => `فشل تشغيل سطح المكتب: ${message}`,
    steps: {
      connectingGateway: 'جار الاتصال ببوابة سطح المكتب',
      loadingSettings: 'جار تحميل إعدادات HBM AGENT',
      loadingSessions: 'جار تحميل الجلسات الأخيرة',
      retryingRemoteBackend: 'جارٍ إعادة الاتصال بخادم HBM AGENT البعيد…',
      startingDesktopConnection: 'جار بدء اتصال سطح المكتب',
      startingHbmDesktop: 'جار تشغيل HBM AGENT Desktop...'
    },
    errors: {
      backgroundExited: 'خرجت عملية HBM AGENT الخلفية.',
      backgroundExitedDuringStartup: 'خرجت عملية HBM AGENT الخلفية أثناء بدء التشغيل.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: 'خلفية HBM AGENT أقدم من إصدار سطح المكتب الحالي وقد لا تعمل كما يجب. حدثهما ليتوافقا.',
    updateHbm: 'تحديث HBM AGENT',
    ...
    errors: {
      ...
      methodNotAllowed: 'رفضت خلفية سطح المكتب هذا الطلب (405 Method Not Allowed). جرب إعادة تشغيل HBM AGENT Desktop.',
    ...
    native: {
      ...
      inputBody: 'ينتظر HBM AGENT ردّك.',
      turnDoneTitle: 'أنهى HBM AGENT',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'هل تريد إعادة كل الإعدادات إلى افتراضيات HBM AGENT؟',
    ...
    vault: {
      ...
      otpHint: '«مفتاح الإعداد» الذي يعرضه الموقع عند تفعيل المصادقة الثنائية. بحفظه يولّد HBM AGENT الرموز بنفسه.',
      ...
      sources: {
        ...
        notInstalled: name => `غير مكتشف. ثبّت أداة سطر الأوامر ${name} وسجّل الدخول إليها؛ سيكتشفها HBM AGENT تلقائيًا.`,
        disabledDesc: 'مكتشف لكنه معطّل لـ HBM AGENT.',
        lockedDesc: 'مكتشف. سيطلب منك الوكيل فتحه عند الحاجة إلى بيانات دخول، أو افتحه الآن.',
        unlockedDesc: 'مفتوح لهذه الجلسة. يُقفل تلقائيًا بعد 30 دقيقة من الخمول أو عند إغلاق HBM AGENT.',
        statusLocked: 'مقفل',
    ...
    plugins: {
      ...
      blurb:
        'امتدادات واجهة تُحمّل داخل هذا التطبيق — إما مضمّنة مع البناء، أو موضوعة في مجلد desktop-plugins (بما فيها التي يكتبها HBM AGENT). تعطيل الإضافة يفرغها مباشرة ويبقى بعد إعادة التشغيل.',
      count: n => `${n} مثبتة`,
    ...
    notifications: {
      ...
      focusedHint: 'تنبيهات الاكتمال تظهر فقط عندما يكون HBM AGENT في الخلفية.',
      kinds: {
        approval: {
          label: 'يلزم الموافقة',
        ...
        input: {
          label: 'يلزم إدخال',
          description: 'طرح HBM AGENT سؤالا أو يحتاج إلى كلمة مرور أو سر.'
        },
        turnDone: {
          label: 'الرد جاهز',
          description: 'انتهى دور بينما كان HBM AGENT في الخلفية.'
        },
        turnError: {
          label: 'فشل الدور',
    ...
    appearance: {
      title: 'المظهر',
      intro: 'خصص مظهر HBM AGENT Desktop.',
      ...
      backdropDesc: 'اختيار مقدار مزج خلفية سطح المكتب مع سطح HBM AGENT.',
      ...
      reactionsDesc: 'تفاعلات إيموجي بأسلوب iMessage — تفاعل مع الرسائل، ويمكن لـ HBM AGENT التفاعل مع رسائلك.',
      tipsTitle: 'نصائح داخل التطبيق',
      tipsDesc:
        'نصائح تظهر أحيانًا من التطبيق وHBM AGENT. تظهر كل نصيحة مرة واحدة. تُعطّل تلقائيًا بعد أول 30 يومًا من الاستخدام، ويمكنك تفعيلها مجددًا.',
      tipsReset: count => `إظهار ${count} نصيحة مرة أخرى`,
      toursTitle: 'جولات إرشادية',
      toursDesc:
        'دع HBM AGENT يرشدك في التطبيق مع إبراز كل خطوة. تُعطّل الجولات تلقائيًا بعد أول 30 يومًا من الاستخدام، ويمكنك تفعيلها مجددًا.',
      ...
      pet: {
        title: 'حيوان أليف',
        intro:
          'تبنَّ تعويذة petdex متحركة تطفو فوق التطبيق وتتفاعل مع ما يفعله HBM AGENT — تجري أثناء تنفيذ الأدوات، وتحتفل عند النجاح، وتعبس عند الأخطاء.',
        restartHint:
          'تحتاج الحيوانات الأليفة إلى إعادة تشغيل سريعة — بدأ التطبيق العامل قبل إضافة هذه الميزة. أغلق HBM AGENT وأعد فتحه، ثم ارجع إلى هنا.',
        on: 'تشغيل',
        off: 'إيقاف',
        scaleTitle: 'الحجم',
    ...
    fieldDescriptions: {
      ...
      timezone: 'تستخدم عندما يحتاج HBM AGENT إلى سياق الوقت المحلي. اتركها فارغة لاستخدام منطقة النظام.',
      'agent.imageInputMode': 'يتحكم في طريقة إرسال مرفقات الصور إلى النموذج.',
      'agent.maxTurns': 'الحد الأعلى لدورات استدعاء الأدوات قبل أن يوقف HBM AGENT التشغيل.',
      ...
      fileReadMaxChars: 'أقصى عدد أحرف يستطيع HBM AGENT قراءته من ملف واحد في الطلب.',
      'approvals.mode': 'كيف يتعامل HBM AGENT مع الأوامر التي تحتاج موافقة صريحة.',
      ...
      'updates.nonInteractiveLocalChanges':
        'عندما يحدّث HBM AGENT نفسه من التطبيق دون موجه طرفية، احتفظ بتعديلات المصدر المحلية أو تجاهلها.'
    },
    about: {
      heading: 'حول HBM AGENT',
      version: value => `الإصدار ${value}`,
      versionUnavailable: 'الإصدار غير متاح',
      bundleOutOfSync: 'إصدار التطبيق قديم',
      bundleOutOfSyncDesc:
        'تم تحديث وقت تشغيل HBM AGENT، لكن تطبيق سطح المكتب نفسه لا يزال إصدارًا قديمًا — لن تظهر ميزات الواجهة الجديدة (مثل Bot Mode) حتى يتم تحديث التطبيق. شغّل التحديث أدناه لإعادة بناء التطبيق. إذا لم يختفِ هذا التحذير، فأعد التثبيت من أحدث مثبّت لسطح المكتب.',
      bundleOutOfSyncAction: 'الحصول على المثبّت',
      bundleSwapPending: 'أعد التشغيل لإكمال التحديث',
      bundleSwapPendingDesc:
        'تم تثبيت التطبيق المحدَّث بالفعل — يكفي إعادة تشغيل HBM AGENT لتحميله. لن تتأثر المحادثات أو الإعدادات.',
      bundleSwapPendingAction: 'إعادة تشغيل HBM AGENT',
      updates: 'التحديثات',
      ...
      automaticUpdatesDesc: 'اسمح لـ HBM AGENT بالتحقق من التحديثات وتثبيتها.',
    ...
    config: {
      ...
      loading: 'جار تحميل إعدادات HBM AGENT...',
    ...
    quickEntry: {
      ...
      enabledDesc: 'استدعِ محرّرا صغيرا من أي مكان باختصار عام وأرسل طلبا دون فتح HBM AGENT.',
    ...
    gateway: {
      ...
      intro:
        'يشغّل HBM AGENT Desktop بوابة محلية خاصة افتراضياً. استخدم بوابة بعيدة عندما تريد أن يتحكم هذا التطبيق بخلفية HBM AGENT تعمل مسبقاً على جهاز آخر أو خلف وكيل موثوق. اتصالات البوابة إعداد على مستوى الجهاز؛ ويتم اكتشاف الملفات الشخصية من البوابات المتصلة.',
      envOverrideTitle: 'متغيرات البيئة تتحكم في جلسة سطح المكتب هذه.',
      envOverrideDesc: 'أزل HBM_DESKTOP_REMOTE_URL و HBM_DESKTOP_REMOTE_TOKEN لاستخدام الإعداد المحفوظ أدناه.',
      localTitle: 'بوابة محلية',
      localDesc: 'تشغيل خلفية HBM AGENT خاصة على localhost. هذا هو الافتراضي ويعمل دون اتصال.',
      remoteTitle: 'بوابة بعيدة',
      remoteDesc:
        'صل واجهة سطح المكتب هذه بخلفية HBM AGENT بعيدة. البوابات المستضافة تستخدم OAuth أو اسم مستخدم وكلمة مرور، والبوابات الذاتية قد تستخدم رمز جلسة.',
      remoteUrlTitle: 'رابط البوابة البعيدة',
      remoteUrlDesc: 'الرابط الأساسي لخلفية لوحة التحكم البعيدة. يمكن استخدام بادئات مسار مثل /hbm.',
      ...
      restartingMessage: 'سيعيد HBM AGENT Desktop الاتصال باستخدام الإعدادات المحفوظة.',
      savedMessage: 'تم الحفظ للتشغيل القادم.',
      connectedTo: (baseUrl, version) => `متصل بـ ${baseUrl}${version ? ` · HBM AGENT ${version}` : ''}`,
    ...
    mcp: {
      ...
      deepLinkDescription:
        'طلب رابط إضافة خادم MCP هذا إلى HBM AGENT. راجع الإعدادات الكاملة أدناه — فهي قادمة من الرابط وليست من HBM AGENT.',
    ...
    providers: {
      ...
      intro: 'سجل الدخول باشتراكك دون نسخ مفتاح API. يشغّل HBM AGENT تسجيل الدخول من المتصفح لك داخل التطبيق.',
      connected: 'متصل',
      collapse: 'طي',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'أعد تشغيل HBM AGENT لاستخدام الحيوانات الأليفة — الخادم الخلفي أقدم من هذه الميزة.',
    ...
    generatePet: {
      ...
      staleBackend: 'حدّث HBM AGENT لتوليد الحيوانات الأليفة.',
      backgroundHint: 'يمكنك إغلاق هذا — سيُعلِمك HBM AGENT عند الانتهاء.',
    ...
    nav: {
      ...
      settings: {
        title: 'الإعدادات',
        detail: 'تكوين HBM AGENT desktop'
      },
      skills: {
    ...
    hbmActiveSessions: (version, count) => `HBM AGENT ${version} لديه ${count} جلسة نشطة`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle: 'كلا الخيارين يربط بوتًا تتحكم به ويحفظ بياناته في هذا التثبيت من HBM AGENT فقط.',
      quickSetup: 'إعداد سريع',
      recommended: 'موصى به',
      quickHelp: 'امسح رمز QR وأكّد في Telegram. سينشئ HBM AGENT البوت ويكتشف معرّف مستخدم Telegram الخاص بك تلقائيًا.',
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'ستعمل جلسات هذا الملف الشخصي على خادم HBM AGENT البعيد الذي تحدده، بدلاً من هذا الجهاز.',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'لم يحفظ HBM AGENT تغيير النموذج هذا.',
    ...
    emptyDescNew: 'أنشئ مهمة مجدولة لتشغيل HBM AGENT تلقائيا.',
    ...
    createDesc: 'اضبط مهمة يشغلها HBM AGENT تلقائيا.',
    nameLabel: 'الاسم',
    namePlaceholder: 'مثال: الملخص الصباحي',
    promptLabel: 'الرسالة',
    promptPlaceholder: 'ماذا تريد من HBM AGENT أن يفعل؟',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'هذا يزيل المشروع المحفوظ من HBM AGENT. تبقى الملفات ومستودعات git وأشجار العمل دون تغيير.',
      ...
      worktreeStaleBackend:
        'حدِّث خادم HBM AGENT لإنشاء أشجار العمل عبر هذا الاتصال البعيد — فهو أقدم من واجهة git worktree.',
  ...
  composer: {
    ...
    placeholderStarting: 'جار بدء HBM AGENT...',
    placeholderReconnecting: 'جار إعادة الاتصال...',
    placeholderFollowUp: 'اكتب متابعة...',
    newSessionPlaceholders: ['اسأل HBM AGENT عن شيء...', 'اطلب من HBM AGENT تنفيذ مهمة...', 'ابدأ محادثة جديدة...'],
    ...
    urlHintPre: 'سيقرأ HBM AGENT الرابط ضمن السياق.',
    attach: 'إرفاق',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'اطلب من HBM AGENT فتح PR',
  ...
  updates: {
    stages: {
      ...
      pydeps: 'جار الإنهاء...',
      update: 'جار تحديث HBM AGENT...',
      rebuild: 'جار إعادة بناء تطبيق سطح المكتب...',
      restart: 'جار إعادة تشغيل HBM AGENT...',
      done: 'اكتمل التحديث',
    ...
    unsupportedMessage: 'لا يمكن لهذا الإصدار من HBM AGENT تحديث نفسه من داخل التطبيق.',
    ...
    availableBody: 'إصدار جديد من HBM AGENT جاهز للتثبيت.',
    availableTitleBackend: 'يتوفر تحديث للواجهة الخلفية',
    availableBodyBackend: 'إصدار أحدث من واجهة HBM AGENT الخلفية المتصلة جاهز للتثبيت.',
    ...
    manualBody: 'لقد ثبّتت HBM AGENT من سطر الأوامر، لذا تُجرى التحديثات من هناك أيضا. الصق هذا في طرفيتك:',
    manualPickedUp: 'سيلتقط HBM AGENT الإصدار الجديد في المرة التالية التي تشغّله فيها.',
    guiSkewTitle: 'تحديث تطبيق سطح المكتب',
    guiSkewBody:
      'تم تحديث الواجهة الخلفية، لكن حزمة تطبيق سطح المكتب هذه لم تتغير. حدّث أو أعد تثبيت تطبيق HBM AGENT لسطح المكتب (ملف AppImage / ‎.deb / ‎.rpm) لمطابقته.',
    copy: 'نسخ',
    copied: 'تم النسخ',
    done: 'تم',
    applyingBody:
      'يتولّى مُحدِّث HBM AGENT المهمة في نافذته الخاصة ويعيد فتح HBM AGENT تلقائيا عند الانتهاء. الرجاء عدم إعادة فتح HBM AGENT بنفسك أثناء التحديث.',
    applyingBodyBackend:
      'تطبّق الواجهة الخلفية البعيدة التحديث وستعيد التشغيل. يعيد HBM AGENT الاتصال تلقائيا عند عودتها.',
    applyingClose: 'ستُغلق هذه النافذة أثناء تشغيل التحديث، ثم يعيد HBM AGENT فتح نفسه تلقائيا.',
    errorTitle: 'لم يكتمل التحديث',
    errorBody: 'لا داعي للقلق — لم يُفقد شيء. يمكنك إعادة المحاولة الآن.',
    blockerTitle: 'إغلاق المعاينات المحلية لتحديث HBM AGENT؟',
    blockerBody: 'يحتاج HBM AGENT إلى إيقاف هذه المعاينات المحلية قبل التحديث. لن يؤدي ذلك إلى تعديل ملفاتك أو حذفها.',
    foreignBlockerTitle: 'أغلق العمليات الأخرى لتحديث HBM AGENT',
    foreignBlockerBody:
      'لا يمكن لـ HBM AGENT إغلاق هذه العمليات تلقائيًا بأمان. أغلق التطبيق أو الطرفية أو الخدمة التي تشغّل كل عملية، ثم حاول التحديث مرة أخرى.',
    mixedBlockerBody:
      'يمكن لـ HBM AGENT إغلاق المعاينات المحلية المدرجة أدناه. يجب إغلاق العمليات الأخرى يدويًا قبل متابعة التحديث.',
  ...
  guidedGreeting: {
    line: 'أهلا، تفضل بالدخول. أنا HBM AGENT. امنحني دقيقتين لأرتب المكان حولك، ثم نبدأ بشيء تريد إنجازه فعلا.\n\nبداية، بماذا أناديك؟',
  ...
  install: {
    ...
    oneTimeTitle: 'يحتاج HBM AGENT إلى تثبيت لمرة واحدة',
    ...
    settingUpTitle: 'جار إعداد وكيل HBM AGENT',
    finishingTitle: 'جار الإنهاء',
    failedDesc:
      'فشلت إحدى خطوات التثبيت. على Windows، قد يحدث هذا إذا كان هناك نسخة أخرى من HBM AGENT CLI أو تطبيق سطح المكتب قيد التشغيل. أوقف أي نسخ HBM AGENT قيد التشغيل، ثم أعد المحاولة. تحقق من التفاصيل أدناه أو من سجل سطح المكتب للحصول على النص الكامل.',
    activeDesc:
      'هذا إعداد لمرة واحدة. يقوم مثبّت HBM AGENT بتنزيل التبعيات وتهيئة جهازك. ستتخطى عمليات التشغيل اللاحقة هذه الخطوة.',
  ...
  onboarding: {
    headerTitle: 'لنُعِدّ لك HBM AGENT',
    headerDesc: 'اربط مزوّد نماذج لبدء المحادثة. معظم الخيارات تتطلب نقرة واحدة.',
    preparingInstall: 'يُكمل HBM AGENT التثبيت. عادة ما يستغرق ذلك أقل من دقيقة في أول تشغيل.',
    starting: 'جار بدء HBM AGENT...',
    ...
    recommended: 'موصى به',
    connected: 'متصل',
    featuredPitch: 'اشتراك واحد، أكثر من 300 نموذج متقدم — الطريقة الموصى بها لتشغيل HBM AGENT',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'مستضاف ذاتيا',
        description:
          'وجّه HBM AGENT إلى نقطة نهاية محلية أو مستضافة ذاتيا متوافقة مع OpenAI (vLLM، llama.cpp، Ollama، إلخ).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'يفتح صفحة تحقق في المتصفح — يتصل HBM AGENT تلقائياً',
      loopback: 'يفتح المتصفح لتسجيل الدخول — يتصل HBM AGENT تلقائياً',
    ...
    authorizeThere: 'صرّح لـ HBM AGENT هناك.',
    copyAuthCode: 'انسخ رمز التفويض وألصقه أدناه.',
    pasteAuthCode: 'ألصق رمز التفويض',
    reopenAuthPage: 'إعادة فتح صفحة التفويض',
    autoBrowser: provider => `فتحنا ${provider} في المتصفح. صرّح لـ HBM AGENT هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `حجم ${label} هو ${size}. سيعرض HBM AGENT أول 512 KB فقط.`,
    ...
    web: {
      ...
      tryAgain: 'إعادة المحاولة',
      restarting: 'جار إعادة تشغيل HBM AGENT...',
      askRestart: 'اطلب من HBM AGENT إعادة تشغيل الخادم',
      lookingRestart: taskId => `يبحث HBM AGENT عن خادم معاينة لإعادة تشغيله (${taskId})`,
      restartingTitle: 'جار إعادة تشغيل خادم المعاينة',
      restartingMessage: 'يعمل HBM AGENT في الخلفية. راقب كونسول المعاينة لمتابعة التقدم.',
      ...
      blankPageBody: 'اكتب عنوانًا في الأعلى للتصفح، أو اطلب من HBM AGENT فتح صفحة.',
      finishedRestarting: message => `أنهى HBM AGENT إعادة تشغيل خادم المعاينة${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'تعذّر على HBM AGENT إعادة تشغيل الخادم.',
      stillWorking:
        'لا يزال HBM AGENT يعمل، لكن لم تصل نتيجة إعادة التشغيل بعد. قد يكون أمر الخادم قيد التشغيل في المقدمة.',
  ...
  prompts: {
    ...
    vaultSaveDesc: origin =>
      `وصل HBM AGENT إلى صفحة تسجيل الدخول في ${origin} ولا توجد بيانات دخول محفوظة لها. أدخلها هنا مرة واحدة؛ تُشفَّر على هذا الجهاز وتُملأ في الصفحة مباشرة، ولا يرى النموذج كلمة المرور أبدًا.`,
    ...
    vaultCodeDesc: site =>
      `يطلب ${site} رمزًا لمرة واحدة (رسالة نصية أو بريد إلكتروني أو تطبيق مصادقة). أدخله هنا وسيكتبه HBM AGENT في الصفحة؛ لا يراه النموذج أبدًا.`,
    vaultCodeLabel: 'الرمز',
    vaultCodeFootnote:
      'تلميح: احفظ مفتاح المصادقة مع بيانات الدخول هذه في الإعدادات ← كلمات المرور وتسجيلات الدخول وسيُدخل HBM AGENT الرموز نيابةً عنك.',
    vaultCodeSkip: 'تخطٍ',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'انتهت المهلة في انتظار البوابة. هل `hbm gateway` قيد التشغيل؟'
    }
  },
  errors: {
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        ...
        text: 'المهارات مجلدات من التعليمات يحمّلها HBM AGENT عندما يقتضي العمل ذلك.'
      },
      messaging: {
        title: 'HBM AGENT بعيدًا عن مكتبك',
        text: 'اربطه بـ Telegram وDiscord وSlack وغيرها — الوكيل نفسه والذاكرة نفسها.'
      },
      artifacts: {
        title: 'كل ما صنعه HBM AGENT',
      ...
      profiles: {
        ...
        text: 'كل واحد منها HBM AGENT مستقل — مفاتيحه وذاكرته وجلساته الخاصة.'
      },
      'composer-mentions': {
