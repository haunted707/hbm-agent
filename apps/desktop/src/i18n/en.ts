...
export const en: Translations = {
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want HBM AGENT to use.',
    execution: 'Connector tools'
  },

  sessionImport: {
    title: 'Continue from another app',
    subtitle: 'Bring a conversation into HBM AGENT and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into HBM AGENT.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in HBM AGENT. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in HBM AGENT',
    continue: 'Continue in HBM AGENT',
  ...
  boot: {
    ready: 'HBM AGENT Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading HBM AGENT settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote HBM AGENT backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHbmDesktop: 'Starting HBM AGENT Desktop…'
    },
    errors: {
      ...
      backgroundExitedDuringStartup: 'HBM AGENT stopped right after it started.',
      backendStopped: 'HBM AGENT stopped working in the background',
      restartHbm: 'Restart HBM AGENT',
      openLogs: 'Open logs',
      desktopBootFailed: "HBM AGENT couldn't start",
      gatewayConnectionLost: 'HBM AGENT lost its connection',
      ...
      gatewaySignInRequired: 'Your remote HBM AGENT signed you out',
      gatewaySignInRequiredDetail: 'Sign in again to reconnect. Your chats and settings are safe.',
      signInAgain: 'Sign in again',
      ipcBridgeUnavailable: "HBM AGENT Desktop couldn't talk to its own background layer. Restart the app."
    },
    // Plain causes for a local backend boot failure (`classifyBootFailure`);
    // the raw output stays behind "Show recent logs".
    causes: {
      exitedEarly: "HBM AGENT' background service stopped right after starting.",
      timedOut: "HBM AGENT' background service didn't answer in time.",
      permission: "HBM AGENT couldn't write to its data folder (permission problem).",
      diskFull: 'The disk is full, so HBM AGENT could not start.',
      portInUse: 'Another program is using the network port HBM AGENT needs.',
      installMissing: "Part of HBM AGENT' installation is missing. Choose Repair install to put it back."
    },
    failure: {
      title: "HBM AGENT couldn't start",
      description:
        "HBM AGENT' background service didn't come up. Try one of the recovery steps below. Nothing here deletes your chats or settings.",
      details: 'Details',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your HBM AGENT backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHbm: 'Update HBM AGENT',
    ...
    errors: {
      ...
      storageFailure: "HBM AGENT couldn't save to its data folder. Open Maintenance to check and repair it.",
      gatewayAuthFailed:
        'This HBM AGENT no longer accepts your saved sign-in. Open Gateways and sign in again (or paste a new access token), then retry.',
      methodNotAllowed: "HBM AGENT' background service is out of step with the app, probably after an update. Restart it to fix this.",
      ...
      codeSkewRestartRequired: 'HBM AGENT was updated but is still running the old version. Restart it to finish the update.',
      restartHbmFailed: "Couldn't restart HBM AGENT"
    },
    actions: {
      restartHbm: 'Restart HBM AGENT',
      openKeys: 'Open Keys',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Could not hand the request to HBM AGENT',
    ...
    native: {
      ...
      inputBody: 'HBM AGENT is waiting for your response.',
      turnDoneTitle: 'HBM AGENT finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `hbm debug share --nous` from a terminal, or `hbm debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to HBM AGENT defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `HBM AGENT catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, HBM AGENT generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; HBM AGENT picks it up automatically.`,
        disabledDesc: 'Detected but turned off for HBM AGENT.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when HBM AGENT closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while HBM AGENT is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'HBM AGENT asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while HBM AGENT was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while HBM AGENT was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let HBM AGENT follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and HBM AGENT can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'Occasional hints from the app and HBM AGENT. Each tip appears once. Turns off automatically after your first 30 days; you can turn it back on.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc:
        'Let HBM AGENT spotlight each step as it guides you through the app. Turns off automatically after your first 30 days; you can turn it back on.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what HBM AGENT is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen HBM AGENT, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    uninstallSection: {
      ...
      uninstallHbm: 'Uninstall HBM AGENT'
    },
    poolLimits: {
    ...
    about: {
      heading: 'HBM AGENT Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The HBM AGENT runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — HBM AGENT only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart HBM AGENT',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'HBM AGENT checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading HBM AGENT configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening HBM AGENT.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every HBM AGENT gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by HBM AGENT Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'HBM AGENT Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The HBM AGENT runtime managed by this app.',
      kindRemoteDesc: 'A HBM AGENT gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your HBM AGENT Cloud account.',
      kindSshDesc: 'A HBM AGENT install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers HBM AGENT manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under HBM AGENT Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      unavailableDesc: 'Connection settings can only be changed from the HBM AGENT Desktop app on the computer running it.',
      title: 'Gateway Connection',
      envOverride: 'env override',
      intro:
        'Local by default. Use remote when this app should drive a HBM AGENT backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'This connection was fixed by the way HBM AGENT was launched.',
      envOverrideDesc:
        'A startup setting outside the app chose this connection, so the options below are read-only. Restart HBM AGENT without that setting — or ask whoever set it up — to change it here.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private HBM AGENT backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote HBM AGENT backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'HBM AGENT Cloud',
      cloudDesc: 'Sign in once to HBM AGENT Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'HBM AGENT Cloud',
      cloudSignIn: 'Sign in to HBM AGENT Cloud',
      cloudSignedIn: 'Signed in to HBM AGENT Cloud',
      cloudNeedsSignIn: 'Sign in to HBM AGENT Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your HBM AGENT Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'HBM AGENT Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of HBM AGENT Cloud',
      cloudSignedOutMessage: 'Cleared the HBM AGENT Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /hbm.',
      probing: 'Checking how this gateway authenticates…',
      probeError: "HBM AGENT can't reach that address. Check the URL and that the other computer is running HBM AGENT — sign-in options appear once it answers.",
      signedIn: 'Signed in',
      signIn: 'Sign in',
      signOut: 'Sign out',
      ...
      restartingMessage: 'HBM AGENT Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · HBM AGENT ${version}` : ''}`,
      ...
      sshDesc:
        'HBM AGENT is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHbmPathTitle: 'HBM AGENT path (optional)',
      sshHbmPathDesc: 'Full path to the remote hbm binary. Blank = auto-detect.',
      sshHbmPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — HBM AGENT found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — HBM AGENT runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'HBM AGENT is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the HBM AGENT path.',
      sshErrPlatform:
        'Unsupported remote platform. HBM AGENT Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update HBM AGENT on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to HBM AGENT. Review the exact configuration below — it comes from the link, not from HBM AGENT.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. HBM AGENT starts and manages the server for you.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. HBM AGENT runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point HBM AGENT at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `HBM AGENT can't run shell commands right now: ${backend} isn't ready. Switch to Local, or finish setting up ${backend} and try again.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let HBM AGENT browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via hbm curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      defaultProfile: 'HBM AGENT (default)',
      kindAgent: 'Agent',
      kindDesktop: 'Desktop',
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update HBM AGENT to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the HBM AGENT catalog${sha ? ` at pin ${sha}` : ''}.`,
  ...
  starmap: {
    ...
    emptyDesc: 'As HBM AGENT builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart HBM AGENT to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update HBM AGENT to generate pets.',
      backgroundHint: 'You can close this — HBM AGENT will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure HBM AGENT desktop' },
    ...
    hbmActiveSessions: (version, count) => `HBM AGENT ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    restartFailedManual: "HBM AGENT couldn't restart to apply your messaging settings",
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this HBM AGENT installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. HBM AGENT creates the bot and detects your Telegram user ID automatically.',
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@hbm:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote HBM AGENT you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://hbm.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent HBM AGENT environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'HBM AGENT did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. HBM AGENT will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the HBM AGENT backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from HBM AGENT. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the HBM AGENT backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting HBM AGENT...',
    placeholderReconnecting: 'Reconnecting to HBM AGENT…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give HBM AGENT a task',
      "What's on your mind?",
    ...
    voiceEngineChained: 'Speech-to-text + HBM AGENT voice',
    voiceEngineLive: 'GPT-Live (full-duplex, delegates to HBM AGENT)',
    ...
    attachUrlDesc: 'HBM AGENT will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask HBM AGENT to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating HBM AGENT…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting HBM AGENT…',
    ...
    unsupportedMessage: 'This version of HBM AGENT can’t update itself from inside the app.',
    connectionRetry:
      "HBM AGENT couldn't reach the update server. Check your internet connection and try again. If you use a remote HBM AGENT, make sure it is online.",
    connectionSettings: 'Connection settings',
    ...
    manualBody: 'You installed HBM AGENT from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'HBM AGENT will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the HBM AGENT desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The HBM AGENT updater takes over in its own window and reopens HBM AGENT automatically when it’s done. Please don’t reopen HBM AGENT yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. HBM AGENT reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then HBM AGENT reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update HBM AGENT?',
    blockerBody:
      'HBM AGENT needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update HBM AGENT',
    foreignBlockerBody:
      'HBM AGENT can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'HBM AGENT can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  handoffTour: {
    ...
    stayTitle: 'HBM AGENT is one click away',
    stayText: 'Switch to the setup profile and open Welcome to HBM AGENT whenever you want a hand. It stays there.'
  },
  guidedGreeting: {
    line: "Hey, come on in. I'm HBM AGENT. Give me two minutes to set the place up around you, then we'll put me to work on something you actually want done.\n\nFirst though, what should I call you?",
  ...
  install: {
    ...
    oneTimeTitle: 'HBM AGENT needs a one-time install',
    ...
    setupChoiceTitle: 'Set up HBM AGENT Desktop',
    setupChoiceDesc:
      'Connect this app to a HBM AGENT gateway you already run, or install HBM AGENT locally on this computer.',
    connectExistingTitle: 'Connect to existing HBM AGENT',
    ...
    installLocalTitle: 'Install HBM AGENT locally',
    installLocalDesc: 'Download HBM AGENT, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart HBM AGENT Desktop and try again.',
    remoteSetupTitle: 'Connect to existing HBM AGENT',
    remoteSetupDesc: 'Enter your gateway URL. HBM AGENT Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the HBM AGENT gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hbm',
    ...
    settingUpTitle: 'Setting up HBM AGENT',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the setup steps did not finish. This can happen when another copy of HBM AGENT is running, the internet connection dropped, or antivirus blocked the installer. Close other HBM AGENT windows, then choose Reload and retry. If it fails again, open the logs and send them to support.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with HBM AGENT",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'HBM AGENT is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting HBM AGENT…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run HBM AGENT',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point HBM AGENT at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — HBM AGENT connects automatically',
    ...
    authorizeThere: 'Authorize HBM AGENT there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize HBM AGENT there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  freeTier: {
    ...
    retiredBody:
      'Your session ended before the sign-in finished. HBM AGENT will start a new one; then sign in again whenever you\'re ready.',
    errorBody: "Sign-in didn't finish. Try again whenever you're ready.",
    busyHeading: 'Almost there',
    busyBody: wait =>
      `HBM AGENT couldn't finish signing you in because the Nous service is busy. Try again in ${wait}. Your session is still here in the meantime.`,
    unreachableBody:
      "HBM AGENT couldn't reach the Nous service to finish signing you in. Check your internet connection and try again. Your session is still here.",
    alreadySignedInHeading: 'Already signed in.',
    alreadySignedInBody: 'This HBM AGENT is already signed in to a Nous account.',
    setupFailed: {
      gateClosed:
        "This version of HBM AGENT can't start without a Nous account. Sign in or create one, it's free and only takes a minute.",
      paused:
        'Using HBM AGENT without signing in is paused for a moment. HBM AGENT will keep checking. Signing in is free and gets you going right now.',
      rateLimited: wait =>
        `Lots of people are getting started right now, so HBM AGENT will try again in ${wait}. Signing in is free and skips the wait.`,
      unreachable:
        "HBM AGENT couldn't reach the Nous service. Check your internet connection, then tap Try again. Or connect another provider for now.",
      ...
      generic: "HBM AGENT couldn't set up free access without signing in. Signing in is free, or connect another provider.",
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `HBM AGENT Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `HBM AGENT Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. HBM AGENT will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'HBM AGENT is restarting...',
      askRestart: 'Ask HBM AGENT to restart the server',
      lookingRestart: taskId => `HBM AGENT is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'HBM AGENT is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask HBM AGENT to open a page.',
      finishedRestarting: message => `HBM AGENT finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'HBM AGENT could not restart the server.',
      stillWorking:
        'HBM AGENT is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'HBM AGENT is loading a response',
      ...
      errorLayers: {
        ...
        gateway: 'HBM AGENT hit a problem',
        generic: "HBM AGENT couldn't finish this reply",
        provider: 'The AI service returned an error',
        runtime: 'HBM AGENT hit a problem',
      ...
      errorLayerBodies: {
        ...
        disk: 'Your disk is full, so HBM AGENT could not save this conversation. Free some space, then retry.',
        endpoint: "HBM AGENT can't reach your custom model server. Check that it is running, then send your message again.",
        gateway: 'HBM AGENT hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
        generic: 'Something went wrong while HBM AGENT was replying. Retry, or copy the details if it keeps happening.',
        provider: 'The AI service could not complete this request. Retry in a moment or switch provider.',
        runtime: 'HBM AGENT hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `HBM AGENT could not verify the secure connection to ${provider}. Check your network or proxy settings, or switch provider, then send your message again.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} returned something HBM AGENT could not read. Retry in a moment.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'HBM AGENT got stuck in a loop',
          body: 'The reply kept repeating the same steps, so HBM AGENT stopped it. Retry, or start a new chat if it happens again.'
        },
        SESSION_NOT_OWNED: {
          title: 'This chat is open somewhere else',
          body: 'This chat is currently open in another HBM AGENT window or terminal. Close it there and send your message again, or start a new chat here.'
        },
        disk_full: {
          title: 'Disk full',
          body: 'Your disk is full, so HBM AGENT could not save this conversation. Free some space, then retry.'
        },
        ...
        free_tier_disabled: {
          title: 'Using HBM AGENT without signing in is switched off right now',
        ...
        free_tier_model_not_free: {
          ...
          body: "HBM AGENT uses the free model for now. Sign in with a Nous account for more models, it's free."
        },
        free_tier_route: {
          title: "HBM AGENT couldn't reach the free model on this route",
        ...
        free_tier_refused: {
          title: "HBM AGENT couldn't send that without signing in",
      ...
      errorToastTitle: "HBM AGENT couldn't finish the reply",
      errorRetry: 'Retry',
      ...
      errorOpenHbmFolder: 'Open HBM AGENT folder',
      errorOpenHbmFolderFailed: 'Could not open the HBM AGENT folder',
    ...
    approval: {
      gatewayDisconnected:
        'HBM AGENT is offline right now. The command is still waiting for your answer (until the approval timeout). Reconnect, then send it again.',
      sendFailed: 'Could not send your answer',
      reconnect: 'Reconnect',
      timedOutSystemLine:
        'Approval timed out — the command was not run. Ask HBM AGENT to try again, or raise the limit in Settings → Safety → Approval timeout.',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hbm/config.yaml). HBM AGENT won’t ask again for commands like this — in this session or any future one.`,
      alwaysAllow: 'Always allow'
    },
    clarify: {
      notReady: 'Clarify request is not ready yet',
      gatewayDisconnected: 'HBM AGENT is offline right now. Reconnect, then send it again.',
  ...
  prompts: {
    ...
    secretDesc: 'HBM AGENT needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `HBM AGENT reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and HBM AGENT types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and HBM AGENT enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart HBM AGENT Desktop to use Save Image.',
    restartToSaveImages: 'Restart HBM AGENT Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: "HBM AGENT couldn't reach your messaging connection. Start it from Settings → Messaging, then try the handoff again.",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions HBM AGENT loads when the work calls for them.'
      },
      messaging: {
        title: 'HBM AGENT away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything HBM AGENT made',
      ...
      profiles: {
        ...
        text: 'Each one is its own HBM AGENT — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
