/**
 * Tells the `hbm desktop` launcher that the main window is on screen.
 *
 ...
 * hands us the write end of a pipe in `HBM_DESKTOP_READY_FD`; one byte means
 * "mapped, safe to heal". A launch without the variable is a no-op.
 */

import fs from 'node:fs'

export const LAUNCHER_READY_FD_ENV = 'HBM_DESKTOP_READY_FD'
