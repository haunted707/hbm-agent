...
// even though a fresh shell — and the HBM AGENT CLI — sees it immediately. The
// desktop's HBM_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\hbm. Reading
...
//       HBM_HOME    REG_SZ    F:\HBM AGENT\data
//
