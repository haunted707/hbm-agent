 ...
 *     it via `hbm:profile:remember` without re-homing the primary.
 ...
 * the same HBM_HOME. That duplicate held a pool slot and starved every other
...
export class PrimaryProfilePin {
  ...
  /** Called by startHbm() with the profile the primary is launching as. */
