 ...
 * (`persist:hbm-remote-oauth`) — the jar was keyed on the auth *mode*, not
 ...
 * setup: one box, two dashboards) fought over the same `hbm_session*`
...
export const LEGACY_OAUTH_PARTITION = 'persist:hbm-remote-oauth'
...
// `Partitions/hbm-remote-oauth%3Aconn%3A<id>` folder is left on disk,
