 ...
 * startHbm() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startHbm() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startHbm`, re-emits
