...
test('a live primary keeps answering for its booted profile after the preference moves', () => {
  ...
  // startHbm() boots the primary as the preference at that moment.
  ...
  // hbm:profile:remember rewrites active-profile.json without re-homing.
  preference = 'claude'
