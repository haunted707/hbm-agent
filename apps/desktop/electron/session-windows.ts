...
// by main.ts (`setBackgroundThrottling` driven by the merged `hbm:active-work`
...
// (the "HBM AGENT idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey HBM AGENT" wake word has NO preceding click,
