...
describe('pickWindowBelow', () => {
  ...
  it('skips our own other windows (same pid) while walking down', () => {
    const secondHbmWindow = win(SELF_PID, 150, 150)
    const target = win(7, 160, 160)

    const { below } = pickWindowBelow([win(SELF_PID, 100, 100), secondHbmWindow, target], SELF_PID, SELF_BOUNDS)
...
describe('resolveOutsideAsar', () => {
  ...
  it('redirects a packaged specifier into app.asar.unpacked', () => {
    expect(
      resolveOutsideAsar('file:///Applications/HBM AGENT.app/Contents/Resources/app.asar/dist/node_modules/get-windows/index.js')
    ).toBe('file:///Applications/HBM AGENT.app/Contents/Resources/app.asar.unpacked/dist/node_modules/get-windows/index.js')
  })
  ...
  it('redirects a Windows packaged path built with backslashes', () => {
    expect(resolveOutsideAsar('C:\\Users\\me\\AppData\\Local\\HBM AGENT\\resources\\app.asar\\dist\\node_modules\\get-windows\\index.js')).toBe(
      'C:\\Users\\me\\AppData\\Local\\HBM AGENT\\resources\\app.asar.unpacked\\dist\\node_modules\\get-windows\\index.js'
    )
  })
  ...
  it('requires app.asar to be a complete path segment', () => {
    for (const untouched of [
      ...
      'file:///Users/dev/hbm-agent/node_modules/get-windows/index.js'
    ]) {
