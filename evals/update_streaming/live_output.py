...
def step(mode):
    from hbm_cli.main_dashboard import _install_hangup_protection, _finalize_update_output
    from hbm_cli.main import _run_logged_subprocess
