...
Scratch HOME, HBM_HOME, Python facade and CLI shims; no user profiles or credentials.
...
(cd apps/desktop && HBM_DESKTOP_CDP_PORT=off BOT_DM_SERVICE_PATH=1 \
...
worktree-pinned `hbm`; PATH contains a different inert `hbm` that exits 2
