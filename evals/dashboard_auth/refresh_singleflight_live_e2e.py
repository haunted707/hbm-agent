...
os.environ["HBM_HOME"] = tempfile.mkdtemp(prefix="hbm-e2e-55712-")
for m in [k for k in sys.modules if k.startswith(("hbm", "tools", "plugins"))]:
    del sys.modules[m]

import uvicorn  # noqa: E402

from hbm_cli import web_server  # noqa: E402
from hbm_cli.dashboard_auth import register_provider  # noqa: E402
from hbm_cli.dashboard_auth.base import RefreshExpiredError, Session  # noqa: E402
from tests.hbm_cli.conftest_dashboard_auth import StubAuthProvider  # noqa: E402
...
idp.calls = 0
ck = "hbm_session_at=expired-at; hbm_session_rt=cookie-stale; hbm_session_provider=stub"
with ThreadPoolExecutor(4) as pool:
