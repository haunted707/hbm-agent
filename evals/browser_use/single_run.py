...
The run gets a throwaway HBM_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE HBM_HOME is redirected to the
