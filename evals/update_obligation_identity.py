...
os.environ["HBM_HOME"] = str(root / ".hbm")
from hbm_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    ...
    d = root / ".hbm/logs/update_receipts"
