...
sandbox = tempfile.TemporaryDirectory(prefix="hbm-104260-")
os.environ.clear()
os.environ.update(
    HOME=sandbox.name,
    HBM_HOME=sandbox.name + "/hbm",
    PATH="/usr/bin:/bin",
    PYTHONDONTWRITEBYTECODE="1",
    HBM_DISABLE_MODEL_METADATA_FETCH="1",
)
...
# JSON is valid YAML; only the temporary HBM AGENT home is written.
