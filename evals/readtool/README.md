...
benchmarked ten harnesses on hostile-file handling — and whose HBM AGENT column
...
Every task runs the full HBM AGENT (file + terminal + search toolsets)
...
Rules of engagement (from hbmbench discipline):
