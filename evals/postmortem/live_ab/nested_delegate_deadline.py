...
# Temp HBM_HOME with the real auth + a config that shortens the generic sequential deadline to 40 s, so the
...
home = tempfile.mkdtemp(prefix="dl_home_"); os.environ["HBM_HOME"] = home
real_home = os.environ.get("HBM_HOME_SOURCE", os.path.expanduser("~/.hbm"))  # credentials are copied from here into a temp home
