...
os.environ.setdefault("HBM_HOME", os.path.expanduser("~/.hbm"))  # LIVE: real auxiliary judge calls (cents)
from hbm_cli import goals
goal = ("Simplify the hbm-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
