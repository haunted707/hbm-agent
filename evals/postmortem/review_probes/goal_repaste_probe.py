...
from hbm_cli import cli_commands_mixin, goals
...
server._hbm_home = Path(home.name)
...
with patch('hbm_cli.goals.draft_contract', return_value=None), contextlib.redirect_stdout(io.StringIO()):
