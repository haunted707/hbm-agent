"""Live E2E: vault fill through the REAL browser_exec path (Browser Use CLI + HBM AGENT's packaged Chromium).
...
Run: HBM_E2E_BROWSER=1 <venv>/bin/python evals/vault_fill_live_e2e.py
"""
...
HOME = Path(tempfile.mkdtemp(prefix="hbm-vault-e2e-"))
