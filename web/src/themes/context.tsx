...
const STORAGE_KEY = "hbm-dashboard-theme";
...
const FONT_STORAGE_KEY = "hbm-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `hbm_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "hbm-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-hbm-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-hbm-theme-font", "true");
