import { parseColor, THEME_PRESET_PALETTES, type ThemePresetPalette } from "@hbm/shared";
 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `hbm_cli/web_server.py`.
 *
 * Presets that also ship on the desktop (midnight, ember, mono, cyberpunk)
 * take their colours from `@hbm/shared` `THEME_PRESET_PALETTES` so both
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "HBM AGENT Teal",
  description: "Classic dark teal — the canonical HBM AGENT look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "HBM AGENT Teal (Large)",
  description: "HBM AGENT Teal with bigger fonts and roomier spacing",
