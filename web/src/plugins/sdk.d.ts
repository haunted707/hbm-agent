/**
 * HBM AGENT Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__HBM_PLUGIN_SDK__`` and
 * ``window.__HBM_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__HBM_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``HbmPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@hbm/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__HBM_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__HBM_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__HBM_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface HbmPluginSDK {
...
declare global {
  interface Window {
    __HBM_PLUGIN_SDK__?: HbmPluginSDK;
    __HBM_PLUGINS__?: PluginRegistry;
  }
}
