 ...
 *
 * Plugins call window.__HBM_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__HBM_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__HBM_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__HBM_PLUGIN_SDK__ = {
    ...
    // window.__HBM_SESSION_TOKEN__ directly.
    authedFetch,
