 ...
 * `window.__HBM_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the HBM AGENT brand in the top bar
 ...
 *  `window.__HBM_PLUGINS__.registerSlot(...)`.
 *
