import { applyDocumentLocale, LOCALE_ENDONYMS } from "@hbm/shared/i18n";
...
// Display metadata for the language picker — endonyms from @hbm/shared so the
