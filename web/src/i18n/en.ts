...
export const en: Translations = {
  ...
  status: {
    ...
    updateHbmConfirmMessage:
      "This runs hbm update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateHbmConfirmNow: "Update now",
    updateHbmConfirmTitle: "Update HBM AGENT?",
    updatingHbm: "Updating HBM AGENT…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update HBM AGENT plugins (`hbm plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.hbm/plugins/?",
    removeHint: "Only user-installed plugins under ~/.hbm/plugins can be removed.",
    ...
    catalogEmptyDocsLink: "Learn about HBM AGENT plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills installed yet. Browse the skills hub or create one here; from a terminal you can also run `hbm skills search <topic>`.",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that HBM AGENT doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "HBM AGENT Achievements",
      subtitle:
        "Collectible HBM AGENT badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning HBM AGENT session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run HBM AGENT more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once HBM AGENT sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "HBM AGENT is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in HBM AGENT ☤",
    },
  },
