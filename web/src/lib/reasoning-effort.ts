 ...
 *
 * Values come from @hbm/shared (hbm_constants.VALID_REASONING_EFFORTS
 * plus `none`, thinking-off). An empty/unset config value means the HBM AGENT
 * default.
 */
 ...
 *  option. Empty/unknown → `medium` (HBM AGENT's default when unset). */
