...
class RelayAdapter(BasePlatformAdapter):
    ...
    async def send_native_task_card_progress(
        ...
        tasks: list,
        *,
        title: str = "HBM AGENT is working",
    ...
    def _discord_interaction_to_event(self, forward):
        ...
        source = SessionSource(
            ...
            # The HBM profile this interaction is routed to (multiplex mode) — mirrors _event_from_wire's
        ...
        if itype == 3:
            # A component press whose custom_id is a HBM AGENT prompt token
