...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your HBM AGENT session"),
        ...
        _cmd("status", "Show HBM AGENT session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running HBM AGENT"),
        ...
        _cmd("update", "Update HBM AGENT to the latest version"),
        _cmd("restart", "Gracefully restart the HBM AGENT gateway"),
        ...
        _cmd("thread", "Create a new thread and start a HBM AGENT session in it",
