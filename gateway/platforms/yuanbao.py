...
from gateway.platforms.yuanbao_proto import (
    CMD_TYPE, WS_HEARTBEAT_RUNNING, WS_HEARTBEAT_FINISH, HBM_INSTANCE_ID,
...
try:
    ...
    _HBM_VERSION = "0.0.0"
_APP_VERSION = _BOT_VERSION = _HBM_VERSION
_YUANBAO_INSTANCE_ID = str(HBM_INSTANCE_ID)
...
class YuanbaoAdapter(BasePlatformAdapter):
    ...
    # Per HBM AGENT home: a multiplexed gateway runs one Yuanbao adapter per profile, and the tools /
    ...
    def get_active(cls) -> Optional["YuanbaoAdapter"]:
        ...
        return cls._active_instances.get(hbm_home_key())
    ...
    def set_active(cls, adapter: Optional["YuanbaoAdapter"]) -> None:
        ...
        if get_hbm_home_override() is None:
            ...
            cls._active_instances.pop(hbm_home_key(), None)
        else:
            cls._active_instances[hbm_home_key()] = adapter
