...
# `require_mention: true` without custom aliases uses HBM AGENT wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?hbm\s+agent\b[,:\-]?", r"(?<![\w@])@?hbm\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (HBM AGENT defaults)."""
