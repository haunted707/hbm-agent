...
the same three things: what HBM AGENT wants to run, why it was flagged, and that silence means
...
EA_HEADER_TEXT = "HBM AGENT wants to run a command that needs your OK"
