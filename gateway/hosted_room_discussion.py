...
# Openers of HBM AGENT' own control frames (agent.prompt_builder.CONTROL_FRAME_OPENERS: the steer marker, the
...
# Genuine user lines are never touched. Keep in sync with apps/desktop hbm-bots/group-round-prompt.ts.
