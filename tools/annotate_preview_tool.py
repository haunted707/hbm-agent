"""Persistent element annotations in the HBM AGENT desktop GUI's in-app browser.
...
def annotate_preview_tool(
    ...
    if callback is None:
        return tool_error("annotate_preview is only available in the HBM AGENT desktop app.")
