"""Close a read-only agent terminal tab in the HBM AGENT desktop GUI WITHOUT killing
...
CLOSE_TERMINAL_SCHEMA = {
    ...
    "description": (
        ...
        "the HBM AGENT desktop GUI (the tabs mirroring terminal(background=true) runs). "
