...
LOCAL_STT_COMMAND_ENV = "HBM_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "HBM_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via hbm_cli.models.deepinfra_base_url (shared).
