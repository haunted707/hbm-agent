...
worktree per child under ``<repo>/.worktrees/subagent-<id>``, branch ``hbm-subagent/<id>``;
...
from hbm_cli._subprocess_compat import harden_git_argv, noninteractive_git_env
