...
Used by hbm_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "HBM_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"HBM_HOME": _hbm_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'HBM_INDEX_TTL': ('tools.skills_hub_search', 'HBM_INDEX_TTL'),
    'HBM_INDEX_URL': ('tools.skills_hub_search', 'HBM_INDEX_URL'),
    'HbmIndexSource': ('tools.skills_hub_official', 'HbmIndexSource'),
