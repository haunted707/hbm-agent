...
_HOMEBREW_CI_POLLER_HINT = (
    ...
    'and/or `gh pr checks | jq`. That shape has burned us repeatedly in hbm-agent dev work '
    ...
    "skill_view(name='github/hbm-agent-dev', file_path='references/green-ci-policy.md') for "
...
# proc_session attribute -> HBM_SESSION_* env var carrying it.
_ROUTING_FIELDS = (
    ("watcher_chat_id", "HBM_SESSION_CHAT_ID"),
    ("watcher_user_id", "HBM_SESSION_USER_ID"),
    ("watcher_user_name", "HBM_SESSION_USER_NAME"),
    ("watcher_thread_id", "HBM_SESSION_THREAD_ID"),
    ("watcher_message_id", "HBM_SESSION_MESSAGE_ID"),
    ...
    ("parent_session_id", "HBM_SESSION_ID"),
)
