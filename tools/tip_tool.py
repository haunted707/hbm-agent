"""Point at something in the HBM AGENT desktop GUI and say one line about it — the quiet
...
def tip_tool(text: str, selector: str, title: str = "", side: str = "") -> str:
    ...
    if not ok:
        return tool_error("tip is only available in the HBM AGENT desktop app.")
