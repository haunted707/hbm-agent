"""Guided tour (highlight + narrate UI elements) in the HBM AGENT desktop GUI: the agent discovers
...
def tour_tool(action: str = "", surface: Optional[str] = None, selector: Optional[str] = None,
    ...
    if callback is None:
        return tool_error("tour is only available in the HBM AGENT desktop app.")
...
TOUR_SCHEMA = {
    ...
    "description": (
        ...
        "element, attach a titled popover. Surfaces: 'app' (HBM AGENT itself) "
