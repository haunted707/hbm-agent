...
async def login_device(name, server_url, oauth_config):
    ...
    from tools.mcp_oauth_manager import HbmMCPOAuthProvider, get_manager
    ...
    provider = HbmMCPOAuthProvider(server_url=server_url, server_name=name, storage=storage,
