...
from hbm_state_common import _BOUNDARY_END_REASONS

# Hidden from browsing/searching — integrations (HBM_SESSION_SOURCE=tool), delegate
...
SESSION_SEARCH_SCHEMA = {
    "name": "session_search",
    "description": (
        "Recall past conversations: search or read old HBM AGENT sessions (FTS5), or "
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "profile": {
                "type": "string",
                "description": (
                    "Optional. Read sessions from another HBM AGENT profile's database "
