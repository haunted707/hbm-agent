...
# containing `cat ~/.hbm/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `hbm-agent-dev` skill contains a security postmortem mentioning `cat ~/.hbm/.env`, which tripped
