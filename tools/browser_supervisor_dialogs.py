...
DIALOG_BRIDGE_HOST = "hbm-dialog-bridge.invalid"
...
(() => {
  if (window.__hbmDialogBridgeInstalled) return;
  window.__hbmDialogBridgeInstalled = true;
  const ENDPOINT = "http://hbm-dialog-bridge.invalid/";
