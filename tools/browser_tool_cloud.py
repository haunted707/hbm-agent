...
def _memo(_bt, resolved_attr: str, cache_attr: str, compute: Callable[[], object]):
    ...
    Under a routed profile (HBM_HOME override, multiplexed gateway) the slot is NOT consulted: every
...
def _get_cloud_provider() -> Optional[CloudBrowserProvider]:
    """Return the provider cached for the active HBM AGENT profile."""
    _bt = _origin()
    scope = hbm_home_key()
