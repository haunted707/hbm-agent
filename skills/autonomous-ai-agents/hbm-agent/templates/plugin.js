/**
 * HBM AGENT desktop plugin template. Save as:
 *   <hbm home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <hbm home> is ~/.hbm by default, or ~/.hbm/profiles/<name>
 * when running a named profile (`hbm -p <name>`). Run `hbm doctor` (or
 ...
 * Only these imports resolve: @hbm/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@hbm/plugin-sdk'
