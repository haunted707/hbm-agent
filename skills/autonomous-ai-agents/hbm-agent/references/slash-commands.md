...
Registry of record: `hbm_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore HBM AGENT config+state snapshots (CLI)
...
/update                  Update HBM AGENT to latest
