#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from HBM AGENT logs.
...
With no LOGFILE, reads ``$HBM_HOME/logs/agent.log`` (default ~/.hbm).
...
def default_log() -> Path:
    home = os.environ.get("HBM_HOME") or str(Path.home() / ".hbm")
