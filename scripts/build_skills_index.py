#!/usr/bin/env python3
"""Build the HBM AGENT Skills Index — a centralized JSON catalog of all skills.
...
`hbm-agent skills search/install` can use it without hitting the GitHub API.
...
# Ensure HBM_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building HBM AGENT Skills Index...", flush=True)
