#!/usr/bin/env python3
"""Build the HBM AGENT Model Catalog — a centralized JSON manifest of curated models.
...
HBM AGENT CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a HBM AGENT release.
...
# Ensure HBM_HOME is set for imports that touch it at module level.
os.environ.setdefault("HBM_HOME", os.path.join(os.path.expanduser("~"), ".hbm"))

from hbm_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
            ...
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model HBM AGENT '
