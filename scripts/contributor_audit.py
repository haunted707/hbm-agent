...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^HBM AGENT\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (hbm-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "hbm@nousresearch.com",
    "hbm-audit@example.com",
