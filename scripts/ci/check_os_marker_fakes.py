...
_BASELINE = frozenset(
    {
        "tests/hbm_cli/test_doctor.py",
        "tests/hbm_cli/test_gateway.py",
        "tests/hbm_cli/test_gateway_proc_fallback.py",
        "tests/hbm_cli/test_linux_sandbox_fixup.py",
        "tests/hbm_cli/test_macos_fda_guidance.py",
        "tests/hbm_cli/test_orphan_desktop_serve_reap.py",
        "tests/hbm_cli/test_update_launchd_restart_verification.py",
        "tests/hbm_cli/test_update_launchd_unloaded_gateway.py",
        "tests/hbm_cli/test_urllib_security.py",
        "tests/hbm_state/test_state_synchronous_pragma.py",
        "tests/test_hbm_constants.py",
