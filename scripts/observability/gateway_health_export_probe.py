...
def main() -> None:
    ...
    hbm_home = Path(tempfile.mkdtemp(prefix="hbm-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "hbm-gateway-smoke",
    ...
    print(json.dumps({"hbm_home": str(hbm_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
