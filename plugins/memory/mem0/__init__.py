...
self-hosted Mem0 server (MEM0_HOST, HTTP), or OSS Memory. Secrets live in $HBM_HOME/.env
(MEM0_API_KEY, MEM0_HOST); settings in $HBM_HOME/mem0.json via `hbm memory setup`:
...
def _load_config() -> dict:
    """Env vars provide defaults; $HBM_HOME/mem0.json overrides individual keys.
    ...
    config = {"mode": get_secret("MEM0_MODE", "") or "platform", "host": get_secret("MEM0_HOST", "") or "",
              "agent_id": get_secret("MEM0_AGENT_ID", "") or "hbm", "oss": {}}
    ...
    file_cfg = read_json_or_empty(get_hbm_home() / "mem0.json")
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._mode, self._api_key, self._host, self._user_id, self._agent_id = "platform", "", "", _DEFAULT_USER_ID, "hbm"
    ...
    def save_config(self, values, hbm_home):
        """Merge-write config to $HBM_HOME/mem0.json."""
        config_path = Path(hbm_home) / "mem0.json"
    ...
    def get_config_schema(self):
        ...
        return [
            ...
            {"key": "user_id", "description": "User identifier", "default": "hbm-user"},
            {"key": "agent_id", "description": "Agent identifier", "default": "hbm"},
            {"key": "rerank", "description": "Enable reranking for recall", "default": "false", "choices": ["true", "false"]},
        ]

    def post_setup(self, hbm_home: str, config: dict) -> None:
        from ._setup import post_setup
        post_setup(hbm_home, config)
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._mode, self._api_key, self._host, self._agent_id = cfg.get("mode", "platform"), cfg.get("api_key", ""), cfg.get("host", ""), cfg.get("agent_id", "hbm")
