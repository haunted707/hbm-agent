...
VECTOR_PROVIDERS: dict[str, dict[str, Any]] = {
    ...
    # not an import-time constant, and ``~/.hbm`` is wrong on Windows and under profiles.
    "qdrant": {"label": "Qdrant", "default_config": {"path": lambda: str(get_hbm_home() / "mem0_qdrant")}, "pip_dep": "qdrant-client"},
    "pgvector": {
        "label": "PGVector",
