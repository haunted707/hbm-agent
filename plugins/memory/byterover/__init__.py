...
$HBM_HOME/byterover/ (profile-scoped); ``memory.byterover.auto_extract: false`` disables curate hooks.
"""
...
def _brv_child_env(brv_path: str) -> Dict[str, str]:
    ...
    if is_multiplex_active():
        env = strip_launch_profile_env(env, get_hbm_home_override())
