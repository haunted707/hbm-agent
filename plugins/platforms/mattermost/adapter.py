...
def interactive_setup() -> None:
    ...
    from hbm_cli.cli_output import prompt, print_header, print_info, print_success
    ...
    print()
    info("📬 Home Channel: where HBM AGENT delivers cron job results and notifications.",
    ...
    print_info("   Open config in your editor:  hbm config edit")
