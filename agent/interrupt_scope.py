...
A host that runs a blocking command on a worker thread (HBM AGENT Console) never sees
...
_ACTIVE_SCOPE: ContextVar[Optional["InterruptScope"]] = ContextVar("hbm_interrupt_scope", default=None)
