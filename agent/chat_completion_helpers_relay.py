...
as the provider stream ends — concurrently with HBM AGENT' consumer thread, which may not have
...
class RelayChatAccumulator:
    ...
    def observe(self, chunk: Any) -> None:
        ...
        choice = choices[0] if choices else None  # HBM AGENT never requests n>1
