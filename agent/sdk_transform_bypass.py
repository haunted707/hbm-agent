...
HBM AGENT assembles these payloads from JSON round-trips, so they are already wire
...
ESCAPE_HATCH_ENV = "HBM_CODEX_SDK_TRANSFORM"
...
def bypass_chat_sdk_request_transform(request_kwargs: dict, client: Any) -> dict:
    ...
    afterwards. HBM AGENT also drives chat-shaped facades that are NOT the SDK (the
