...
_SESSION_CWD: ContextVar = ContextVar("HBM_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the HBM AGENT source tree, a
    legitimate workspace when developing HBM AGENT; fallback-directory policy lives in the caller."""
