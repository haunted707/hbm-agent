...
def _fire_pre_api_request_hook(
    ...
    try:
        from hbm_cli.lifecycle import has_hook, invoke_hook as _invoke_hook
...
def build_api_request(
    ...
    try:
        from hbm_cli.middleware import apply_llm_request_middleware
    ...
    if env_var_enabled("HBM_DUMP_REQUESTS"):
