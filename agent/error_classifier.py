...
# Parameters HBM AGENT sends on SOME routes only → hosts where that is deliberate.
...
def _plugin_verdict(c: _Ctx) -> Optional[Verdict]:
    ...
    try:
        from hbm_cli.plugins import get_plugin_error_classification
