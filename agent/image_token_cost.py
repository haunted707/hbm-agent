...
The learned value is kept per ``model@host`` in ``~/.hbm/cache/image_token_costs.json`` so a new
...
_image_cost_var: ContextVar[Optional[int]] = ContextVar("hbm_image_token_cost", default=None)
