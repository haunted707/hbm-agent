...
def resolve_provider(*, require_references: bool = True, prefer: str | None = None) -> SpriteProvider:
    ...
    Preference: ``HBM_PET_IMAGE_PROVIDER`` (QA override, unknown values ignored),
    ...
    forced = os.environ.get("HBM_PET_IMAGE_PROVIDER", "").strip().lower()
    ...
    raise GenerationError(
        ...
        "Open `hbm tools` → Image Generation and configure Nous Portal, "
