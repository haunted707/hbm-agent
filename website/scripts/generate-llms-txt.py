#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the HBM AGENT docs site.
...
LLM reads to learn what HBM AGENT does.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use HBM AGENT as a Python Library", None),
        ("guides/use-mcp-with-hbm", "Use MCP with HBM AGENT", None),
        ("guides/use-voice-mode-with-hbm", "Use Voice Mode with HBM AGENT", None),
        ("guides/use-soul-with-hbm", "Use SOUL.md with HBM AGENT", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with HBM AGENT"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "hbm-agent/main/scripts/install.sh | bash`  "
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# HBM AGENT — Full Documentation\n",
        (
            "This file is the entire HBM AGENT documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using HBM AGENT, Features, Messaging, Integrations, Guides, "
