  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the HBM AGENT community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use HBM AGENT &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with HBM AGENT?{' '}
        <a
