---
sidebar_position: 8
title: "Use Voice Mode with HBM AGENT"
description: "A practical guide to setting up and using HBM AGENT voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with HBM AGENT
...
- you want HBM AGENT sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in HBM AGENT.
...
## Step 1: make sure normal HBM AGENT works first
...
HBM AGENT supports both local and cloud speech stacks.
...
4. HBM AGENT transcribes and responds
...
- asking HBM AGENT to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full HBM AGENT loop.

## Tuning CLI behavior

### Silence threshold

If HBM AGENT starts/stops too aggressively, tune:
...
HBM AGENT stays a normal chat bot, but can speak replies.
...
- you want HBM AGENT to function like a portable research or ops assistant
...
HBM AGENT joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- HBM AGENT detects speech boundaries
- transcripts are posted in the associated text channel
- HBM AGENT responds in text and audio
...
1. get text HBM AGENT working
2. run `hbm setup tts` to enable voice support
