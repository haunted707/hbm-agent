...
description: "How the HBM AGENT Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the HBM AGENT Desktop app connects to a **gated gateway** (a hosted or
...
For HBM AGENT specifically, native sign-in means:
...
- [Run HBM AGENT with Nous Portal](./run-hbm-with-nous-portal.md)
