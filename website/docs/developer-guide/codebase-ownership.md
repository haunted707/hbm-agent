...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `hbm_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `hbm_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build an HBM AGENT Plugin](plugins/index.md) |
...
| Session storage | `hbm_state.py`, `hbm_state_*.py` | [Session Storage](session-storage.md) |
