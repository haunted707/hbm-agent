...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain\solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by HBM AGENT |
| License | MIT |
...
Helper script path: ~/.hbm/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.hbm/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.hbm/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.hbm/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.hbm/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.hbm/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.hbm/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
