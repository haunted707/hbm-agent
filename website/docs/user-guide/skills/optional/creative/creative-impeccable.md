...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/creative/impeccable` |
...
> ships and verifies an HBM AGENT-native skill bundle under `.hbm/skills/`.
> `hbm skills install impeccable` pulls the current bundle live from that
