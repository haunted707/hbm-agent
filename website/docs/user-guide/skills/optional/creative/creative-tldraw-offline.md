...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/creative/tldraw-offline` |
...
- **Agent skills installed in the app**: `Develop → Install Agent Skills`. The
  ...
  recipes below. (This HBM AGENT skill mirrors that guidance for HBM AGENT.)
