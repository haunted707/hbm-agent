...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/creative/ascii-art` |
| Path | `optional-skills/creative\ascii-art` |
| Version | `4.0.0` |
| Author | 0xbyt4, HBM AGENT |
| License | MIT |
...
```bash
python -m pyfiglet "HBM" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=HBM&font=Slant" | boxes -d stone
```
