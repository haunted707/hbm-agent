...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`hbm-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hbm-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
HBM AGENT via the native MCP client. This is the preferred
...
Then configure HBM AGENT to connect via HTTP:
