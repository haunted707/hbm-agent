...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/research/osint-investigation` |
| Path | `optional-skills/research\osint-investigation` |
| Version | `0.1.0` |
| Author | HBM AGENT (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $HBM_OSINT_CACHE/icij/ (default: ~/.cache/hbm-osint/icij/).
...
# Set HBM_OSINT_UA=your-app/1.0 (your@email) to identify yourself
