...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/research/blogwatcher` |
...
## Working with HBM AGENT tools (read this first)

`blogwatcher-cli` is the feed database; HBM AGENT tools do the automation around it:
