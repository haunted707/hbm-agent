...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/research/gitnexus-explorer` |
...
| Related skills | [`hbm-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hbm-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/software-development/software-development-codebase-inspection) |
