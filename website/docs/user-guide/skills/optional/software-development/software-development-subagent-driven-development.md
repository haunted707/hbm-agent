...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development\subagent-driven-development` |
| Version | `1.1.0` |
| Author | HBM AGENT (adapted from obra/superpowers) |
| License | MIT |
