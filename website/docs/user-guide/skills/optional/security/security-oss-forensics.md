...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/security/oss-forensics` |
...
> resolve `SKILL_DIR` to the actual path — e.g. `~/.hbm/skills/security/oss-forensics/`
