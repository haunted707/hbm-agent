...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/health/neuroskill-bci` |
...
Connect HBM AGENT to a running [NeuroSkill](https://neuroskill.com/) instance to read
