...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/web-development/page-agent` |
...
- User wants **HBM AGENT itself to drive a browser** → use HBM AGENT's built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
