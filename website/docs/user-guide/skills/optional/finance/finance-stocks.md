...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), HBM AGENT |
| License | MIT |
...
```
SCRIPT=~/.hbm/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.hbm/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
