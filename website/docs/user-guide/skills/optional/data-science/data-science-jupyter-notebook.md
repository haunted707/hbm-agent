...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing hbm tool access (web_search, file ops). Stateless. |
