...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/productivity/shop` |
| Path | `optional-skills/productivity\shop` |
| Version | `1.0.1` |
| Author | Joe Rinaldi Johnson (joerj123), HBM AGENT |
| License | MIT |
...
| Telegram (HBM AGENT + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
