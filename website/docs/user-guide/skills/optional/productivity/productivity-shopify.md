...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"HBM AGENT","productType":"Apparel","tags":["test"]}}'
```
