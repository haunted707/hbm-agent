...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/productivity/decision-questionnaire` |
| Path | `optional-skills/productivity\decision-questionnaire` |
| Version | `1.0.0` |
| Author | Matt Pocock (mattpocock/skills, to-questionnaire) + HBM AGENT |
| License | MIT |
