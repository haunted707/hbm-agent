...
| | |
|---|---|
| Source | Optional — install with `hbm skills install official/productivity/property-listings` |
...
Present researched properties as browsable cards in the HBM AGENT desktop transcript.
...
- An HBM AGENT desktop conversation for native cards; the backend may be local or remote.
...
```text
hbm skills install official/productivity/property-listings
```
