...
| [`hbm-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hbm-agent) | Use, configure, theme, extend, and orchestrate HBM AGENT. | `autonomous-ai-agents\hbm-agent` |
...
| [`hbm-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-hbm-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\hbm-agent-skill-authoring` |
| [`inspecting-hbm-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-hbm-desktop-dom) | Read the live HBM AGENT desktop DOM/CSS over CDP. | `software-development\inspecting-hbm-desktop-dom` |
