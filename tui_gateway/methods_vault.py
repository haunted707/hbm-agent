...
backend): the requested profile's HBM_HOME and secret scope are bound around the body, so the
...
def _(rid, params: dict) -> dict:
    ...
    rows = [{"name": "local", "display_name": "HBM AGENT vault", "enabled": True, "needs_unlock": False,
