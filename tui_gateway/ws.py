...
def _sanitize_ws_text(text: str) -> str:
    ...
    closed. Same U+FFFD replacement every other HBM AGENT transport applies.
...
async def handle_ws(ws: Any, *, auth_identity: dict | None = None, subprotocol: str | None = None) -> None:
    ...
    try:
        ...
        if ready_ok:
            # Live-apply skins HBM AGENT activates mid-conversation, and track this peer for session-less
