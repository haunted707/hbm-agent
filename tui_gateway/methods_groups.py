...
_WORKER_UNAVAILABLE = "Group Chat worker is unavailable. Restart the HBM AGENT gateway and try again."
...
def _profile_name() -> str:
    return (os.getenv("HBM_PROFILE") or "default").strip() or "default"
