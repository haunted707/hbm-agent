"""Telegram DM topic-mode mixin for :class:`hbm_state.SessionDB`."""
...
from hbm_state_common import _PREVIEW_ELIGIBLE_SQL, _PREVIEW_RAW_SELECT, _sql_session_last_active
...
class SessionTelegramTopicsMixin:
    ...
    def bind_telegram_topic(
        ...
        """Bind one Telegram DM topic thread to one HBM AGENT session. A session may be linked to
